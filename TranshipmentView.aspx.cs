...
namespace RET
{
    public partial class TranshipmentView : System.Web.UI.Page
    {
        ...
        //}
        TranshipmentClass obj = new TranshipmentClass();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string qry11s2Q = "select SUM(TotalLineAmount) as  TotalLineAmount  from dbo.TranshipmentItemDtl where PermitId='" + txt_code.Text + "' and MessageType='INPDEC'";
                ...
                if (Update != "")
                {
                    ...
                    if (Update == "AMEND")
                    {
                        ...
                        TranshipmentClass lod12 = new TranshipmentClass();
                        ...
                        if (lod12.dr.HasRows)
                        {
                            ...
                            {
                                int value=0;
                                TranshipmentClass obj4 = new TranshipmentClass();
                        ...
                        TranshipmentClass lod121 = new TranshipmentClass();
        ...
        private void BindCondition()
        {
            ...
            string qry112Q = "SELECT * FROM TransPMT where PermitNumber='" + Permitnum + "'";
            obj.dr = obj.ret_dr(qry112Q);
            while (obj.dr.Read())
            {
            ...
            string status = "";
            TranshipmentClass select = new TranshipmentClass();
            obj.dr = obj.ret_dr("Select * from TranshipmentHeader Where  MSGId='" + msgid + "'");
            if (obj.dr.Read())
            {
            ...
            //{
            //    TranshipmentClass obj1 = new TranshipmentClass();
            //    obj1.dr = obj1.ret_dr("Select * from TranshipmentHeader Where PermitNumber='" + Permitnum + "'");
            //    if (obj1.dr.Read())
            //    {
            ...
            if (status == "APR")
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNo, ConditionCode as Code, ConditionDescription as Description FROM TransPMT Where PermitNumber='" + Permitnum + "' order by Sno"))
                    {
            ...
            else if (status == "ERR")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNo ,ErrorCode as Code, ErrorDescription+' '+ErrorTrace as Description FROM TransErrorStatus Where MsgID='" + msgid + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "REJ")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNO, ErrorID  as Code , ErrorDescription as Description FROM TransRejectStatus Where MsgID='" + msgid + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "CNL")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNO, ConditionCde  as Code , ConditionDes as Description FROM TransCancelPermit Where MsgID='" + msgid + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "AME")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNO, ConditionCode  as Code , ConditionDescription as Description FROM TransAMDPMT Where PermitNumber='" + Permitnum + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
        ...
        private void editCPCAEO()
        {
            SqlConnection con = new SqlConnection(sqlconn);
            //SqlCommand cmd1 = new SqlCommand("SELECT T1.Id ,T1.CRP,T1.CompanyName,T1.Name,T1.EmailId,T1.Mobile, T2.Name as Rent ,t1.BudgetFrom,T1.BudgetTo ,T3.Name as Type,T4.Name as Location,T5.PropertyRef,T1.MultipleLocation,T1. MultipleProperty  FROM (select a.Id,a.CompanyName,a.Name,a.EmailId,a.Mobile,a.BudgetFrom,a.BudgetTo,b.Name as CRP,a.MultipleLocation,a.MultipleProperty  from lead a,CommonMaster b where a.Per_Com=b.Id and a.TouchUser='" + Touch_user + "') AS T1 JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.RentorBuy=b.Id) AS T2    ON T1.Id = T2.Id    JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Type=b.Id) AS T3  ON T1.Id = T3.Id     JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Location=b.Id) AS T4   ON T1.Id = T4.Id    JOIN ( select b.ID,b.Name,a.PropertyRef  from Lead_List a,Lead b where a.ParentId=b.Id) AS T5   ON T1.Id = T5.Id order by T1.Id desc", con);
            SqlCommand cmd1 = new SqlCommand("select RowNo as RowNumber,ProcessingCode1,ProcessingCode2,ProcessingCode3 from TranshipmentHeader a,TranshipmentCPCDtl b where a.PermitId=b.PermitId and a.PermitId='" + txt_code.Text + "' and b.CPCType='AEO'", con);
            SqlDataAdapter sda1 = new SqlDataAdapter(cmd1);
            DataTable dt = new DataTable();
            sda1.Fill(dt);
            //if (dt.Rows.Count > 0)
        ...
        private void editCPCcwc()
        {
            SqlConnection con = new SqlConnection(sqlconn);
            //SqlCommand cmd1 = new SqlCommand("SELECT T1.Id ,T1.CRP,T1.CompanyName,T1.Name,T1.EmailId,T1.Mobile, T2.Name as Rent ,t1.BudgetFrom,T1.BudgetTo ,T3.Name as Type,T4.Name as Location,T5.PropertyRef,T1.MultipleLocation,T1. MultipleProperty  FROM (select a.Id,a.CompanyName,a.Name,a.EmailId,a.Mobile,a.BudgetFrom,a.BudgetTo,b.Name as CRP,a.MultipleLocation,a.MultipleProperty  from lead a,CommonMaster b where a.Per_Com=b.Id and a.TouchUser='" + Touch_user + "') AS T1 JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.RentorBuy=b.Id) AS T2    ON T1.Id = T2.Id    JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Type=b.Id) AS T3  ON T1.Id = T3.Id     JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Location=b.Id) AS T4   ON T1.Id = T4.Id    JOIN ( select b.ID,b.Name,a.PropertyRef  from Lead_List a,Lead b where a.ParentId=b.Id) AS T5   ON T1.Id = T5.Id order by T1.Id desc", con);
            SqlCommand cmd1 = new SqlCommand("select RowNo as RowNumber,ProcessingCode1,ProcessingCode2,ProcessingCode3 from TranshipmentHeader a,TranshipmentCPCDtl b where a.PermitId=b.PermitId and a.PermitId='" + txt_code.Text + "' and b.CPCType='STS' ", con);
            SqlDataAdapter sda1 = new SqlDataAdapter(cmd1);
            DataTable dt = new DataTable();
            sda1.Fill(dt);
            if (dt.Rows.Count <= 0)
        ...
        private void editCPCSEASTORE()
        {
            SqlConnection con = new SqlConnection(sqlconn);
            //SqlCommand cmd1 = new SqlCommand("SELECT T1.Id ,T1.CRP,T1.CompanyName,T1.Name,T1.EmailId,T1.Mobile, T2.Name as Rent ,t1.BudgetFrom,T1.BudgetTo ,T3.Name as Type,T4.Name as Location,T5.PropertyRef,T1.MultipleLocation,T1. MultipleProperty  FROM (select a.Id,a.CompanyName,a.Name,a.EmailId,a.Mobile,a.BudgetFrom,a.BudgetTo,b.Name as CRP,a.MultipleLocation,a.MultipleProperty  from lead a,CommonMaster b where a.Per_Com=b.Id and a.TouchUser='" + Touch_user + "') AS T1 JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.RentorBuy=b.Id) AS T2    ON T1.Id = T2.Id    JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Type=b.Id) AS T3  ON T1.Id = T3.Id     JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Location=b.Id) AS T4   ON T1.Id = T4.Id    JOIN ( select b.ID,b.Name,a.PropertyRef  from Lead_List a,Lead b where a.ParentId=b.Id) AS T5   ON T1.Id = T5.Id order by T1.Id desc", con);
            SqlCommand cmd1 = new SqlCommand("select RowNo as RowNumber,ProcessingCode1,ProcessingCode2,ProcessingCode3 from TranshipmentHeader a,TranshipmentCPCDtl b where a.PermitId=b.PermitId and a.PermitId='" + txt_code.Text + "' and b.CPCType='SEASTORE' ", con);
            SqlDataAdapter sda1 = new SqlDataAdapter(cmd1);
            DataTable dt = new DataTable();
            sda1.Fill(dt);
            if (dt.Rows.Count <= 0)
        ...
        private void EditDocument()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("select * from transhipfile where InPaymentId='" + MsgNO + "'"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        cmd.Connection = con;
        ...
        public void Transhipmentedit()
        {
            ...
            while (obj.dr.Read())
            {
                ...
                while (obj.dr.Read())
                {
                    ...
                    lblimporterparty.Text = obj.dr[4].ToString() + " - " + obj.dr[2].ToString();
                ...
                while (obj.dr.Read())
                {
                    ...
                    LblHandAgent.Text = obj.dr[4].ToString() + " - " + obj.dr[2].ToString();
                }
        ...
        private void BindGridCancel()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("SELECT * FROM TranscANFile where InPaymentId='" + txt_code.Text + "' "))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        cmd.Connection = con;
        ...
        public DataTable GetImportDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM Importer where Code Like '%" + ImporterSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        {
            string Code = "";
            string qry11 = "SELECT Code FROM transInwardcarrier where Code='" + InwardCode.Text + "'";
            ...
            if (Code == "")
            {
                ...
                string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                string StrQuery = ("INSERT INTO [dbo].[transInwardcarrier] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + InwardCode.Text + "','" + InwardName.Text + "','" + InwardName1.Text + "','" + InwardCRUEI.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                obj.exec(StrQuery);
                BindInward();
            }
            else
        ...
        public DataTable GetInwardDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM transInwardcarrier where Code Like '%" + InwardSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void InwardCode_TextChanged(object sender, EventArgs e)
        {
            if (InwardCode.Text != "")
            {
                ...
                string qry11 = "select * from transInwardcarrier where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        {
            string Code = "";
            string qry11 = "SELECT Code FROM transfreight where Code='" + FrieghtCode.Text + "'";
            ...
            if (Code == "")
            {
                ...
                string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                string StrQuery = ("INSERT INTO [dbo].[transfreight] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + FrieghtCode.Text + "','" + FrieghtName.Text + "','" + FrieghtName1.Text + "','" + FrieghtCRUEI.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                obj.exec(StrQuery);
                BindFrieght();
            }
            else
        ...
        public DataTable GetFreightDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM transfreight where Code Like '%" + FrieghtSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void FrieghtCode_TextChanged(object sender, EventArgs e)
        {
            if (FrieghtCode.Text != "")
            {
                ...
                string qry11 = "select * from transfreight where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        protected void FrieghtGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransfreight.X = 300;
            popuptransfreight.Y = 100;
        ...
        protected void LoadingGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransloadingport.X = 300;
            popuptransloadingport.Y = 100;
        }
        ...
        protected void LocationGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransreleaseloc.X = 300;
            popuptransreleaseloc.Y = 100;
        }
        ...
        protected void ReceiptGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransrecloc.X = 300;
            popuptransrecloc.Y = 100;
        }
                ...
                using (Stream fs = postedFile.InputStream)
                {
                    using (BinaryReader br = new BinaryReader(fs))
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(constr))
                        {
                            ...
                            string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                            string query = "insert into transhipfile values (@Name, @ContentType, @Data,@DocumentType,@TranshipId,@TouchUser,@TouchTime)";
        ...
        protected void TxtHSCodeItem_TextChanged(object sender, EventArgs e)
        {
            if (TxtHSCodeItem.Text != "")
            {
                ...
                TranshipmentClass objitm = new TranshipmentClass();
        ...
        private void hscode(string hscode)
        {
            ...
            //string TYPEId = "";
            TranshipmentClass objhsn = new TranshipmentClass();
        ...
        protected void CountryGridItem_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransorgin.X = 300;
            popuptransorgin.Y = 100;
        }
        ...
        protected void ProductCode3Search_TextChanged(object sender, EventArgs e)
        {
            ...
            ModalPopupExtender2.X = 300;
            ModalPopupExtender2.Y = 100;
        }
        ...
        protected void OutwardGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransoutward.X = 300;
            popuptransoutward.Y = 100;
        }
        ...
        {
            string Code = "";
            string qry11 = "SELECT Code FROM [transOutward] where Code='" + OutwardCode.Text + "'";
            ...
            if (Code == "")
            {
                ...
                string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                string StrQuery = ("INSERT INTO [dbo].[transOutward] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + OutwardCode.Text + "','" + OutwardName.Text + "','" + OutwardName1.Text + "','" + OutwardCRUEI.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                obj.exec(StrQuery);
                BindOutward();
            }
            else
        ...
        public DataTable GetOutwardDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM [transOutward] where Code Like '%" + OutwardSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void OutwardCode_TextChanged(object sender, EventArgs e)
        {
            if (OutwardCode.Text != "")
            {
                ...
                string qry11 = "select * from [transOutward] where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        {
            string Code = "";
            string qry11 = "SELECT Code FROM [HandingAgent] where Code='" + TxtExpCode.Text + "'";
            ...
            if (Code == "")
            {
                ...
                string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                string StrQuery = ("INSERT INTO [dbo].[HandingAgent] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + TxtExpCode.Text + "','" + TxtExpName.Text + "','" + TxtExpName1.Text + "','" + TxtExpCRUEI.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                obj.exec(StrQuery);
                BindExporter();
            }
            else
        ...
        public DataTable GetExportDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM [HandingAgent] where Code Like '%" + ExporterSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void TxtExpCode_TextChanged(object sender, EventArgs e)
        {
            if (TxtExpCode.Text != "")
            {
                ...
                string qry11 = "select * from [HandingAgent] where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        protected void ConsigneeGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransconsignee.X = 300;
            popuptransconsignee.Y = 75;
        ...
        {
            string Code = "";
            string qry11 = "SELECT ConsigneeCode FROM transConsignee where ConsigneeCode='" + ConsigneeCode.Text + "'";
            obj.dr = obj.ret_dr(qry11);
            while (obj.dr.Read())
            {
                Code = obj.dr[0].ToString();
        ...
        public DataTable GetConsigneeDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT * FROM transConsignee where ConsigneeCode Like '%" + ConsigneeSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void ConsigneeCode_TextChanged(object sender, EventArgs e)
        {
            if (ConsigneeCode.Text != "")
            {
                ...
                string qry11 = "select * from transConsignee where ConsigneeCode='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        protected void ExportGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransdischargeport.X = 300;
            popuptransdischargeport.Y = 100;
        ...
        protected void NextPortGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransnxtport.X = 300;
            popuptransnxtport.Y = 100;
        ...
        protected void txtlastprt_TextChanged(object sender, EventArgs e)
        {
            ...
            popuptranslastport.X = 300;
            popuptranslastport.Y = 100;
        }
        ...
        private void editbindProduct1(string ID)
        {
            ...
            while (obj.dr.Read())
            {
                ...
                TranshipmentClass objprc = new TranshipmentClass();
        ...
        protected void EndUserGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransenduser.X = 300;
            popuptransenduser.Y = 75;
        ...
        {
            string Code = "";
            string qry11 = "SELECT EndUserCode FROM transEnduser where EndUserCode='" + EndUserCode.Text + "'";
            obj.dr = obj.ret_dr(qry11);
            while (obj.dr.Read())
            {
                Code = obj.dr[0].ToString();
            ...
            if (Code == "")
            {
                string Touch_user = Session["UserId"].ToString();
                string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                string StrQuery = ("INSERT INTO [dbo].[transEnduser] ([EndUserCode],[EndUserName],[EndUserName1],[EndUserCRUEI],[EndUserAddress],[EndUserAddress1],[EndUserCity],[EndUserSub],EndUserSubDivi,[EndUserPostal],[EndUserCountry],[TouchUser],[TouchTime])  VALUES ('" + EndUserCode.Text + "','" + EndUserName.Text + "','" + EndUserName1.Text + "','" + EndUserCrueo.Text + "','" + EndUserAddress.Text + "','" + EndUserAddress1.Text + "','" + EndUserCity.Text + "','" + EndUserSubCode.Text + "','" + EndUserSubCodeDivi.Text + "','" + EndUserPostal.Text + "','" + EndUserCountry.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                obj.exec(StrQuery);
                BindEndUser();
            }
            else
        ...
        public DataTable GetEndUserDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT * FROM transEnduser where EndUserCode Like '%" + EndUserSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void EndUserCode_TextChanged(object sender, EventArgs e)
        {
            if (EndUserCode.Text != "")
            {
                ...
                string qry11 = "select * from transEnduser where EndUserCode='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
                    ...
                    EndUserCity.Text = obj.dr["EndUserCity"].ToString();
                    EndUserSubCode.Text = obj.dr["EndUserSub"].ToString();
                    EndUserSubCode.Text = obj.dr["EndUserSubDivi"].ToString();
                    EndUserPostal.Text = obj.dr["EndUserPostal"].ToString();
                    EndUserCountry.Text = obj.dr["EndUserCountry"].ToString();
        ...
        protected void StorageGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popuptransstorage.X = 300;
            popuptransstorage.Y = 100;
        ...
        {
            TranshipmentClass curobj = new TranshipmentClass();
                ...
                else
                {
                    ...
                    if (count < 50)
                    {
                        ...
                        else
                        {
                            ...
                            string SumofItemAmount = "";
                            string qry11s2Q = "select SUM(TotalLineAmount) as  TotalLineAmount  from dbo.TranshipmentItemDtl where PermitId='" + txt_code.Text + "' and MessageType='TNPDEC'";
                            obj.dr = obj.ret_dr(qry11s2Q);
                            while (obj.dr.Read())
                            {
                                SumofItemAmount = obj.dr[0].ToString();
        ...
        protected void TxtOPQty_TextChanged(object sender, EventArgs e)
        {
            ...
            if (TxtOPQty.Text != "")
            {
                ...
                if (TDQUOM.SelectedItem.Text == "LTR")
                {
                    ...
                    if (A && B)
                    {
                        txttotDutiableQty.Text = (T1 * T3).ToString();
                        TxtHSQuantity.Text = (T1 * T3).ToString();
                    }
                }
                ...
                else if (TDQUOM.SelectedItem.Text == "KGM" && kgmvis == "DIVIDE")
                {
                    if (A && B)
                    {
                        txttotDutiableQty.Text = ((T1 * T3) / 1000).ToString();
                ...
                else if (TDQUOM.SelectedItem.Text == "STK")
                {
                    ...
                    {
                        txttotDutiableQty.Text = ((T1 * T3)).ToString();
                        TxtHSQuantity.Text = ((T1 * T3) / 1000).ToString();
        ...
        protected void TxtIMPQty_TextChanged(object sender, EventArgs e)
        {
            ...
            if (TxtIMPQty.Text != "")
            {
                ...
                if (TDQUOM.SelectedItem.Text == "LTR")
                {
                    ...
                    if (A && B)
                    {
                        txttotDutiableQty.Text = (T1 * T2 * T3 * T8 * T4).ToString();
                        TxtHSQuantity.Text = (T1 * T2 * T3 * T8 * T4).ToString();
                    }
                }
                else if (TDQUOM.SelectedItem.Text == "KGM" && kgmvis == "MULTIPLE")
                {
                ...
                else if (TDQUOM.SelectedItem.Text == "KGM" && kgmvis == "DIVIDE")
                {
                    if (A && B)
                    {
                        txttotDutiableQty.Text = ((T1 * T2 * T3 * T8 * T4) / 1000).ToString();
        ...
        {
            lblgrossweight.Text = TxtTotalGrossWeight.Text;
            transhipsummery.Update();
        ...
        private void AddItemSummary()
        {
            ...
            string CmdString = "select UnitPriceCurrency,TotalLineAmount  from dbo.TranshipmentItemDtl where PermitId='" + txt_code.Text + "' and MessageType='TNPDEC'  ORDER BY UnitPriceCurrency DESC";
        ...
        public void ReqValidatePageLoad()
        {
            ...
            if (DrpDecType.SelectedItem.ToString() == "BRE : BLANKET REMOVAL")
            {
                ...
                if (BlankDate1.Text == "")
                {
                    ErrorDes = ErrorDes + "Cargo -  Please Enter REMOVAL START DATE : ";
        ...
        protected void btnCopyAll_Click(object sender, EventArgs e)
        {
            ...
            TranshipmentClass cpyobj = new TranshipmentClass();
