...
<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ManageMailboxList.aspx.cs" Inherits="RET.ManageMailboxList" %>
                 ...
                 <div class="">       
                    <asp:GridView ID="GridView1" HeaderStyle-CssClass="w-full h-10 py-4 px-10 bg-[#F4F6FA] rounded-l-lg" PagerStyle-CssClass="pager" RowStyle-CssClass="rows" AllowPaging="true" DataKeyNames="Id" Font-Size="Small" ShowHeaderWhenEmpty="true" EmptyDataText="No Records found" PageSize="10" Width="100%" FooterStyle-CssClass="w-full h-10 py-4 px-10 bg-[#F4F6FA] rounded-lg" runat="server" AutoGenerateColumns="false" CssClass="w-full bg-white rounded whitespace-nowrap" RowStyle-Font-Bold="true" >
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="TradeNet Mailbox ID" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500  px-2 text-left pl-0" >
                                                <ItemTemplate>
                                                    <p class="text-slate-500 text-xs font-medium py-3 md:px-0 px-2 rounded-l-lg">
                                                        <asp:Label ID="LblTradeNetMailboxID" runat="server"
                                                        Text='<%#Eval("TradeNetMailboxID")%>'>
                                                        </asp:Label>
                                                    </p>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                        <asp:TemplateField HeaderText="TradeNet Account ID" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500  px-2 text-left pl-0"  >
                                        <ItemTemplate>
                                          <p class="text-slate-500 text-xs font-medium py-3 md:px-0 px-2 rounded-l-lg">
                                            <asp:Label ID="LblTradenetAccount" runat="server"
                                            Text='<%#Eval("TradenetAccount")%>'>
                                            </asp:Label>
                                          </p>
                                        </ItemTemplate>
                                        </asp:TemplateField>
