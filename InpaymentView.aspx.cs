...
namespace RET
{
    public partial class InpaymentView : System.Web.UI.Page
    {
        ...
        public static string uom, exrate, exuom, crate, cuom, kgmvis, ss1,Permitno, msgid = "";
           ...
           // GetData();
            if (!IsPostBack)
            {
              ...
              //  GetData();
                ...
                //Currency1
                string str11s = "select Top 20 Id,Currency from [Currency] order by Currency";
                ...
                //TCurrency2
                string str4 = "select Top 20 Id,Currency from [Currency]  order by Currency";
        ...
        public static List<string> GetListofCountries(string prefixText, string DecAccountID)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select top 5 Code,Name from  DeclarantCompany where AccountID='" + DecAccountID + "' and  Code like '" + prefixText + "%' ", sqlconn);
        ...
        public static List<string> GetImpcode(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 Code,Name from  Importer where Code like '" + prefixText + "%' ", sqlconn);
        ...
        public static List<string> GetInwcode(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 Code,Name from  InwardCarrierAgent where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Name", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        public static List<string> GetFrieght(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 Code,Name from  FreightForwarder where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Name", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        public static List<string> GetClaimanity(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 Name,Name1 from  ClaimantParty where Name like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Name", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        public static List<string> GetLodcode(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 10 PortCode,PortName from  LoadingPort where PortCode like '" + prefixText + "%' ", sqlconn);
        ...
        public static List<string> Getrelloc(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 10 Code,Description from  ReleaseLocation where Code like '" + prefixText + "%' ", sqlconn);
        ...
        public static List<string> GetRecLoc(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 10 Code,Description from  ReceiptLocation where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Description", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        public static List<string> Getsupcode(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 Code,Name from  SUPPLIERMANUFACTURERPARTY where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Name", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        public static List<string> GetInhouse(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 InhouseCode from  InhouseItemCode where InhouseCode like '" + prefixText + "%' ", sqlconn);
        ...
        public static List<string> GetHSCodeItem(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 HSCode,Description from  HSCode where HSCode like '" + prefixText + "%' ", sqlconn);
        ...
        public static List<string> GetCountryItem(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 CountryCode,Description  from  Country where CountryCode like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Description", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        private void BindGrid()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("SELECT Id,DocumentType,Name FROM InFile where InPaymentId='" + MsgNO+ "' "))
                {
        ...
        public DataTable GetDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM DeclarantCompany where Code Like '%" + DecSearch.Text + "%' or Name Like '%" + DecSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void BtnImpADD_Click(object sender, EventArgs e)
        {
            ...
            {
                string Code = "";
                string qry11 = "SELECT Code FROM Importer where Code='" + TxtImpCode.Text + "'";
                ...
                if (Code == "")
                {
                    ...
                    string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                    string StrQuery = ("INSERT INTO [dbo].[Importer] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + TxtImpCode.Text + "','" + TxtImpName.Text + "','" + TxtImpName1.Text + "','" + TxtImpCRUEI.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                    obj.exec(StrQuery);
                    BindImport();
                }
                else
        ...
        public DataTable GetImportDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM Importer where Code Like '%" + ImporterSearch.Text + "%' or Name Like '%" + ImporterSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void TxtImpCode_TextChanged(object sender, EventArgs e)
        {
            if (TxtImpCode.Text != "")
            {
                ...
                string qry11 = "select Top 1 Code,Name,Name1,CRUEI from Importer where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                if (obj.dr.Read())
                {
        ...
        protected void InwardAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                string Code = "";
                string qry11 = "SELECT Code FROM InwardCarrierAgent where Code='" + InwardCode.Text + "'";
        ...
        protected void BtnFrieghtAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Notify", "alert('Notification : The Freight Forwarder Is Empty');", true);
            }
            else if (string.IsNullOrWhiteSpace(FrieghtCRUEI.Text))
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Notify", "alert('Notification : The Freight Forwarder UEI Is Empty');", true);
            }
            ...
            {
                string Code = "";
                string qry11 = "SELECT Code FROM FreightForwarder where Code='" + FrieghtCode.Text + "'";
                ...
                if (Code == "")
                {
                    ...
                    string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                    string StrQuery = ("INSERT INTO [dbo].[FreightForwarder] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + FrieghtCode.Text + "','" + FrieghtName.Text + "','" + FrieghtName1.Text + "','" + FrieghtCRUEI.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                    obj.exec(StrQuery);
                    BindFrieght();
                }
                else
        ...
        public DataTable GetFreightDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM FreightForwarder where Code Like '%" + FrieghtSearch.Text + "%' or Name Like '%" + FrieghtSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void FrieghtCode_TextChanged(object sender, EventArgs e)
        {
            if (FrieghtCode.Text != "")
            {
                ...
                string qry11 = "select Top 1 Code,Name,Name1,CRUEI from FreightForwarder where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                if (obj.dr.Read())
                {
        ...
        private void BindClaimant()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("SELECT Top 20 Id,Name,Name1,CRUEI,ClaimantName,ClaimantName1 FROM ClaimantParty"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        cmd.Connection = con;
        ...
        protected void ClaimantAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Notify", "alert('Notification : The  Claimant Party Is Empty');", true);
            }
            else if (string.IsNullOrWhiteSpace(TxtImpName.Text))
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Notify", "alert('Notification : The  Claimant Party Is Empty');", true);
            ...
            {
                string Code = "";
                string qry11 = "SELECT Name FROM ClaimantParty where Name='" + ClaimantName.Text + "'";
                ...
                if (Code == "")
                {
                    ...
                    string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                    string StrQuery = ("INSERT INTO [dbo].[ClaimantParty] ([Name],[Name1],[Name2],[CRUEI],[ClaimantName],[ClaimantName1],[TouchUser],[TouchTime]) VALUES ('" + ClaimantName.Text + "','" + ClaimantName1.Text + "','"+ClaimantName2.Text+"','" + ClaimantCRUEI.Text + "','" + ClaimantNameC.Text + "','" + ClaimantName1C.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                    obj.exec(StrQuery);
                    BindClaimant();
                }
                else
        ...
        public DataTable GetClaimantDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Name,Name1,Name2,CRUEI,ClaimantName,ClaimantName1 FROM ClaimantParty where Name Like '%" + a + "%' or Name1 Like '%" + a + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void ClaimantName_TextChanged(object sender, EventArgs e)
        {
            if (ClaimantName.Text != "")
            {
                ...
                string qry11 = "select Top 1 Name,Name1,Name2,CRUEI,ClaimantName,ClaimantName1 from ClaimantParty where Name='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                if (obj.dr.Read())
                {
        ...
        protected void txtcodeinvq_TextChanged(object sender, EventArgs e)
        {
            if (txtcodeinvq.Text != "")
            {
                ...
                string qry11 = "select * from SUPPLIERMANUFACTURERPARTY where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        {
            string Code = "";
            string qry11 = "SELECT Code FROM SUPPLIERMANUFACTURERPARTY where Code='" + txtcodeinvq.Text + "'";
            ...
            if (Code == "")
            {
                ...
                string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                string StrQuery = ("INSERT INTO [dbo].[SUPPLIERMANUFACTURERPARTY] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + txtcodeinvq.Text + "','" + txtName.Text + "','" + txtName1.Text + "','" + txtcruei.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                obj.exec(StrQuery);
                BindGrid();
            }
            else
                ...
                using (Stream fs = postedFile.InputStream)
                {
                    using (BinaryReader br = new BinaryReader(fs))
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(constr))
                        {
                            ...
                            string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                            string query = "insert into InFile values (@Sno,@Name, @ContentType, @Data,@DocumentType,@InPaymentId,@TouchUser,@TouchTime,@filePath)";
        ...
        public DataTable GetCountryFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT * FROM Country where CountryCode Like '%" + CountrySearchItem.Text + "%' or Description Like '%" + CountrySearchItem.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Code == "")
                    {
                        ...
                        string StrQuery1 = ("INSERT INTO [dbo].[InvoiceDtl] ([SNo],[InvoiceNo],[InvoiceDate],[TermType],[AdValoremIndicator],[PreDutyRateIndicator],[SupplierImporterRelationship],[SupplierCode],[ImportPartyCode],[TICurrency],[TIExRate],[TIAmount],[TISAmount],[OTCCharge],[OTCCurrency],[OTCExRate],[OTCAmount],[OTCSAmount],[FCCharge],[FCCurrency],[FCExRate],[FCAmount],[FCSAmount],[ICCharge],[ICCurrency],[ICExRate],[ICAmount],[ICSAmount],[CIFSUMAmount],[GSTPercentage],[GSTSUMAmount],[MessageType],[PermitId],[TouchUser],[TouchTime]) VALUES ( '" + txtserial.Text + "','" + txtinvNo.Text + "','" + Convert.ToDateTime(InvoiceDate).ToString("yyyy/MM/dd") + "','" + DrpTerms.SelectedItem + "','" + chkindicator.Checked.ToString() + "','" + chkrateind.Checked.ToString() + "','" + DrpSupImpRel.SelectedItem + "','" + txtcodeinvq.Text + "','" + TxtImppartyCode.Text + "','" + Drpcurrency1.SelectedItem + "','" + Convert.ToDecimal(LblTotalInvoice.Text).ToString() + "','" + Convert.ToDecimal(TxtTotalInvoice.Text).ToString() + "','" + Convert.ToDecimal(SumTotalInvoice.Text).ToString() + "','" + Convert.ToDecimal(OtherTaxableChargePer.Text).ToString() + "','" + Drpcurrency2.SelectedItem + "','" + Convert.ToDecimal(lblOtherTaxableCharge.Text).ToString() + "','" + Convert.ToDecimal(TxtOtherTaxableCharge.Text).ToString() + "','" + Convert.ToDecimal(SumOtherTaxableCharge.Text).ToString() + "','" + Convert.ToDecimal(FrieghtChargesPer.Text).ToString() + "','" + Drpcurrency3.SelectedItem + "','" + Convert.ToDecimal(LblFrieghtCharges.Text).ToString() + "','" + Convert.ToDecimal(TxtFrieghtCharges.Text).ToString() + "','" + Convert.ToDecimal(SumFrieghtCharges.Text).ToString() + "','" + Convert.ToDecimal(InsuranceChargesPer.Text).ToString() + "','" + Drpcurrency4.SelectedItem + "','" + Convert.ToDecimal(lblInsuranceCharges.Text).ToString() + "','" + Convert.ToDecimal(TxtInsuranceCharges.Text).ToString() + "','" + Convert.ToDecimal(SumInsuranceCharges.Text).ToString() + "','" + Convert.ToDecimal(LblSumOFTotal.Text).ToString() + "','" + LblGSTpercentage.Text + "','" + Convert.ToDecimal(lblGSTAmount.Text).ToString() + "','" + TxtMsgType.Text + "','" + txt_code.Text + "','" + Touch_user + "','" + strTime + "')");
                        obj.exec(StrQuery1);
                        obj.closecon();
                        BindInvoice();
                        //}
        ...
        private void BindInvoice()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("SELECT Top 20 * FROM InvoiceDtl where PermitId='" + txt_code.Text + "' and MessageType='IPTDEC' order by Id"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        cmd.Connection = con;
        ...
        public void Insertdata()
        {
                ...
                Save:
                    string StrQuery = (" INSERT INTO [dbo].[InHeaderTbl] ([JobId],[MSGId],[PermitId],[TradeNetMailboxID],[MessageType],[DeclarationType],[PreviousPermit],[CargoPackType],[InwardTransportMode],[BGIndicator],[SupplyIndicator],[ReferenceDocuments],[License],[Recipient],[DeclarantCompanyCode],[ImporterCompanyCode],[InwardCarrierAgentCode],[FreightForwarderCode],[ClaimantPartyCode],HBL,[ArrivalDate],[LoadingPortCode],[VoyageNumber],[VesselName],[OceanBillofLadingNo],[ConveyanceRefNo],[TransportId],[FlightNO],[AircraftRegNo],[MasterAirwayBill],[ReleaseLocation],ReleaseLocName,[RecepitLocation],[RecepitLocName],[TotalOuterPack],[TotalOuterPackUOM],[TotalGrossWeight],[TotalGrossWeightUOM],[GrossReference],[BlanketStartDate],[TradeRemarks],[InternalRemarks],[CustomerRemarks],[Status],[prmtStatus],[TouchUser],[TouchTime],[DeclareIndicator],[NumberOfItems],[TotalCIFFOBValue],[TotalGSTTaxAmt],[TotalExDutyAmt],[TotalCusDutyAmt],[TotalODutyAmt],[TotalAmtPay]) Values ('" + JobNo + "','" + MsgNO + "','" + txt_code.Text + "','" + TxtTradeMailID.Text + "','" + TxtMsgType.Text + "','" + DrpDecType.SelectedItem.ToString() + "','" + TxtPrevPerNO.Text + "','" + DrpCargoPackType.SelectedItem.ToString() + "','" + DrpInwardtrasMode.SelectedItem.ToString() + "','" + DrpBGIndicator.SelectedItem.ToString() + "','" + ChkSupplyIndicator.Checked.ToString().ToLower() + "','" + ChkRefDoc.Checked.ToString().ToLower() + "','" + License + "','" + Recipient + "','" + TxtDecCompCode.Text + "','" + TxtImpCode.Text + "','" + InwardCode.Text + "','" + FrieghtCode.Text + "','" + ClaimantName.Text + "','" + txthBlCargo.Text + "','" + Convert.ToDateTime(ArrivalDate).ToString("yyyy/MM/dd") + "','" + TxtLoadShort.Text + "','" + TxtVoyageno.Text + "','" + TxtVesselName.Text + "','" + TxtOceanBill.Text + "','" + TxtConRefNo.Text + "','" + TxtTrnsID.Text + "','" + txtflight.Text + "','" + txtaircraft.Text + "','" + txtwaybill.Text + "','" + txtreLoctn.Text + "','" + txtrelocDeta.Text + "','" + txtrecloctn.Text + "','" + txtrecloctndet.Text + "','" + TxttotalOuterPack.Text + "','" + DrptotalOuterPack.SelectedItem.ToString() + "','" + TxtTotalGrossWeight.Text + "','" + DrpTotalGrossWeight.SelectedItem.ToString() + "','" + TxtGrossReference.Text + "','" + Convert.ToDateTime(BlanketDate).ToString("yyyy/MM/dd") + "','" + txttrdremrk.Text + "','" + txtintremrk.Text + "','" + txtcusRemrk.Text + "','NEW','NEW','" + Touch_user + "','" + strTime + "','" + chkDeclareInd.Checked.ToString().ToLower() + "','" + txtnoofitm.Text + "','" + txtfobval.Text + "','" + txttotgstAmt.Text + "','" + txttotexAmt.Text + "','" + txtcusdutyAmt.Text + "','" + txtothtaxAmt.Text + "','" + txtAmtPayble.Text + "')");
        ...
        protected void DrpInvoiceNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            obj.dr = obj.ret_dr("Select TermType from [InvoiceDtl] where MessageType='IPTDEC' AND PermitId='" + txt_code.Text + "' and InvoiceNo='" + DrpInvoiceNo.SelectedItem.ToString() + "'");
            while (obj.dr.Read())
            {
        ...
        protected void TxtTotalLineAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            string qry11 = "select TISAmount,OTCSAmount,FCSAmount,ICSAmount from [InvoiceDtl] where MessageType='IPTDEC' AND PermitId='" + txt_code.Text + "' and InvoiceNo='" + DrpInvoiceNo.SelectedItem.ToString() + "'  ";
            obj.dr = obj.ret_dr(qry11);
            while (obj.dr.Read())
            {
            ...
            if (TxtTotalLineAmount.Text != "")
            {
                ...
                TxtItemSumGST.Text = Math.Round((T4 * 7 / 100), 2).ToString();
            ...
            summerygst = (sumex * 0.07) + (itemgst * 0.07) + (optional * 0.07);
        ...
        protected void TxtUnitPrice_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                string termtype = "";
                string qry11 = "select TermType from [InvoiceDtl] where MessageType='IPTDEC' AND PermitId='" + txt_code.Text + "' and InvoiceNo='" + DrpInvoiceNo.SelectedItem.ToString() + "'  ";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
                ...
                TxtItemSumGST.Text = Math.Round(Convert.ToDecimal(((Convert.ToDouble(GSTG) * 7 / 100).ToString())), 2).ToString();
            }
            else
            {
        ...
        public void enablefun()
        {
            ...
            DrpDecType.Enabled = false;

            //DrpDecType.SelectedItem.Text = obj.dr[6].ToString();
            DrpCargoPackType.Enabled = false;

            DrpCargoPackType.Enabled = false;

            DrpInwardtrasMode.Enabled = false;
            ...
            txtintremrk.Enabled = false;
            txtcusRemrk.Enabled = false;
            TxtPrevPerNO.Enabled = false;
          //lb.Enabled = false;

            BlankDate1.Enabled = false;
            ...
            TxtImpCode.Enabled = false;
            TxtImpName.Enabled = false;
            TxtImpName1.Enabled = false;
            TxtImpCRUEI.Enabled = false;
            ...
            ClaimantName.Enabled = false;
            ClaimantName1.Enabled = false;
            ClaimantCRUEI.Enabled = false;
            ClaimantNameC.Enabled = false;
            ClaimantName1C.Enabled = false;
            ...
            TxtSumExRate.Enabled = false;
            TxtTotalLineAmount.Enabled = false;
            Drpcurrency4.Enabled = false;


            TxtTotalLineCharges.Enabled = false;
            TxtCIFFOB.Enabled = false;
            TxtOPQty.Enabled = false;
            TxtIPQty.Enabled = false;
            Drpcurrency3.Enabled = false;
            ...
            txtShippingMarks2.Enabled = false;
            txtShippingMarks3.Enabled = false;

            txtShippingMarks4.Enabled = false;

            //invoice

            txtName.Enabled = false;
            txtcodeinvq.Enabled = false;
            txtName1.Enabled = false;
            txtcruei.Enabled = false;
            TxtImppartyCode.Enabled = false;
            TxtImppartyName.Enabled = false;

            TxtImppartyName1.Enabled = false;
            TxtImppartyCRUEI.Enabled = false;

            txtserial.Enabled = false;
            txtinvNo.Enabled = false;
            DrpTerms.Enabled = false;

            DrpSupImpRel.Enabled = false;


            txtcodeinvq.Enabled = false;
            //  TxtImppartyCode.Text = "";

            Drpcurrency1.Enabled = false;

            LblTotalInvoice.Enabled = false;
            TxtTotalInvoice.Enabled = false;
            SumTotalInvoice.Enabled = false;
            OtherTaxableChargePer.Enabled = false;
            Drpcurrency2.Enabled = false;

            lblOtherTaxableCharge.Enabled = false;
            TxtOtherTaxableCharge.Enabled = false;
            SumOtherTaxableCharge.Enabled = false;
            FrieghtChargesPer.Enabled = false;
            Drpcurrency3.Enabled = false;

            LblFrieghtCharges.Enabled = false;
            TxtFrieghtCharges.Enabled = false;
            SumFrieghtCharges.Enabled = false;
            InsuranceChargesPer.Enabled = false;
            Drpcurrency4.Enabled = false;

            lblInsuranceCharges.Enabled = false;
            TxtInsuranceCharges.Enabled = false;
            SumInsuranceCharges.Enabled = false;
            FrieghtChargesPer.Enabled = false;
            DRPCurrency.Enabled = false;
            ...
            TxtInsuranceCharges.Enabled = false;
            SumInsuranceCharges.Enabled = false;
            LblSumOFTotal.Enabled = false;
            LblGSTpercentage.Enabled = false;
        ...
        public void InPaymentEdit()
        {
            ...
            //}
           // string strBindTxtBox = "select * from [InHeaderTbl] where Id=" + Id;
            obj.dr = obj.ret_dr(strBindTxtBox);
            while (obj.dr.Read())
            {
        ...
        private void editCPCAEO()
        {
            SqlConnection con = new SqlConnection(sqlconn);
            //SqlCommand cmd1 = new SqlCommand("SELECT T1.Id ,T1.CRP,T1.CompanyName,T1.Name,T1.EmailId,T1.Mobile, T2.Name as Rent ,t1.BudgetFrom,T1.BudgetTo ,T3.Name as Type,T4.Name as Location,T5.PropertyRef,T1.MultipleLocation,T1. MultipleProperty  FROM (select a.Id,a.CompanyName,a.Name,a.EmailId,a.Mobile,a.BudgetFrom,a.BudgetTo,b.Name as CRP,a.MultipleLocation,a.MultipleProperty  from lead a,CommonMaster b where a.Per_Com=b.Id and a.TouchUser='" + Touch_user + "') AS T1 JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.RentorBuy=b.Id) AS T2    ON T1.Id = T2.Id    JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Type=b.Id) AS T3  ON T1.Id = T3.Id     JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Location=b.Id) AS T4   ON T1.Id = T4.Id    JOIN ( select b.ID,b.Name,a.PropertyRef  from Lead_List a,Lead b where a.ParentId=b.Id) AS T5   ON T1.Id = T5.Id order by T1.Id desc", con);
            SqlCommand cmd1 = new SqlCommand("select RowNo as RowNumber,ProcessingCode1,ProcessingCode2,ProcessingCode3 from InHeaderTbl a,CPCDtl b where a.PermitId=b.PermitId and b.CPCType='AEO' and a.PermitId='" + txt_code.Text + "'", con);
            SqlDataAdapter sda1 = new SqlDataAdapter(cmd1);
            DataTable dt = new DataTable();
            sda1.Fill(dt);
            if (dt.Rows.Count <= 0)
        ...
        private void editCPCcwc()
        {
            SqlConnection con = new SqlConnection(sqlconn);
            //SqlCommand cmd1 = new SqlCommand("SELECT T1.Id ,T1.CRP,T1.CompanyName,T1.Name,T1.EmailId,T1.Mobile, T2.Name as Rent ,t1.BudgetFrom,T1.BudgetTo ,T3.Name as Type,T4.Name as Location,T5.PropertyRef,T1.MultipleLocation,T1. MultipleProperty  FROM (select a.Id,a.CompanyName,a.Name,a.EmailId,a.Mobile,a.BudgetFrom,a.BudgetTo,b.Name as CRP,a.MultipleLocation,a.MultipleProperty  from lead a,CommonMaster b where a.Per_Com=b.Id and a.TouchUser='" + Touch_user + "') AS T1 JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.RentorBuy=b.Id) AS T2    ON T1.Id = T2.Id    JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Type=b.Id) AS T3  ON T1.Id = T3.Id     JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Location=b.Id) AS T4   ON T1.Id = T4.Id    JOIN ( select b.ID,b.Name,a.PropertyRef  from Lead_List a,Lead b where a.ParentId=b.Id) AS T5   ON T1.Id = T5.Id order by T1.Id desc", con);
            SqlCommand cmd1 = new SqlCommand("select RowNo as RowNumber,ProcessingCode1,ProcessingCode2,ProcessingCode3 from InHeaderTbl a,CPCDtl b where a.PermitId=b.PermitId and b.CPCType='CWC' and a.PermitId='" + txt_code.Text + "'", con);
            SqlDataAdapter sda1 = new SqlDataAdapter(cmd1);
            DataTable dt = new DataTable();
            sda1.Fill(dt);
            ViewState["CurrentTable1"] = dt;
        ...
        private void EditDocument()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("select * from InFile where InPaymentId='" + MsgNO  + "'"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        cmd.Connection = con;
        ...
        Save:
            string Nullval = "0.00";
            string StrQuery = (" INSERT INTO [dbo].[InpaymentTemp] ([Refid],[JobId],[MSGId],[PermitId],[TradeNetMailboxID],[MessageType],[DeclarationType],[PreviousPermit],[CargoPackType],[InwardTransportMode],[BGIndicator],[SupplyIndicator],[ReferenceDocuments],[License],[Recipient],[DeclarantCompanyCode],[ImporterCompanyCode],[InwardCarrierAgentCode],[FreightForwarderCode],[ClaimantPartyCode],HBL,[ArrivalDate],[LoadingPortCode],[VoyageNumber],[VesselName],[OceanBillofLadingNo],[ConveyanceRefNo],[TransportId],[FlightNO],[AircraftRegNo],[MasterAirwayBill],[ReleaseLocation],ReleaseLocName,[RecepitLocation],[TotalOuterPack],[TotalOuterPackUOM],[TotalGrossWeight],[TotalGrossWeightUOM],[GrossReference],[BlanketStartDate],[TradeRemarks],[InternalRemarks],[CustomerRemarks],[Status],[prmtStatus],[TouchUser],[TouchTime],[DeclareIndicator],[NumberOfItems],[TotalCIFFOBValue],[TotalGSTTaxAmt],[TotalExDutyAmt],[TotalCusDutyAmt],[TotalODutyAmt],[TotalAmtPay]) Values ('" + refno + "','" + JobNo + "','" + MsgNO + "','" + txt_code.Text + "','" + TxtTradeMailID.Text + "','" + TxtMsgType.Text + "','" + DrpDecType.SelectedItem.ToString() + "','" + TxtPrevPerNO.Text + "','" + DrpCargoPackType.SelectedItem.ToString() + "','" + DrpInwardtrasMode.SelectedItem.ToString() + "','" + DrpBGIndicator.SelectedItem.ToString() + "','" + ChkSupplyIndicator.Checked.ToString().ToLower() + "','" + ChkRefDoc.Checked.ToString().ToLower() + "','" + License + "','" + Recipient + "','" + TxtDecCompCode.Text + "','" + TxtImpCode.Text + "','" + InwardCode.Text + "','" + FrieghtCode.Text + "','" + ClaimantName.Text + "','" + txthBlCargo.Text + "','" + Convert.ToDateTime(ArrivalDate).ToString("yyyy/MM/dd") + "','" + TxtLoadShort.Text + "','" + TxtVoyageno.Text + "','" + TxtVesselName.Text + "','" + TxtOceanBill.Text + "','" + TxtConRefNo.Text + "','" + TxtTrnsID.Text + "','" + txtflight.Text + "','" + txtaircraft.Text + "','" + txtwaybill.Text + "','" + txtreLoctn.Text + "','" + txtrelocDeta.Text + "','" + txtrecloctn.Text + "','" + TxttotalOuterPack.Text + "','" + DrptotalOuterPack.SelectedItem.ToString() + "','" + TxtTotalGrossWeight.Text + "','" + DrpTotalGrossWeight.SelectedItem.ToString() + "','" + TxtGrossReference.Text + "','" + Convert.ToDateTime(BlanketDate).ToString("yyyy/MM/dd") + "','" + txttrdremrk.Text + "','" + txtintremrk.Text + "','" + txtcusRemrk.Text + "','NEW','NEW','" + Touch_user + "','" + strTime + "','" + chkDeclareInd.Checked.ToString().ToLower() + "','" + Nullval + "','" + Nullval + "','" + Nullval + "','" + Nullval + "','" + Nullval + "','" + Nullval + "','" + Nullval + "')");
            // string StrQuery = (" INSERT INTO [dbo].[InHeaderTbl] ([JobId],[MSGId],[PermitId],[TradeNetMailboxID],[MessageType],[DeclarationType],[CargoPackType],[InwardTransportMode],[BGIndicator],[SupplyIndicator],[ReferenceDocuments],[License],[Recipient],[DeclarantCompanyCode],[ImporterCompanyCode],[InwardCarrierAgentCode],[FreightForwarderCode],[ClaimantPartyCode],[ArrivalDate],[LoadingPortCode],[VoyageNumber],[VesselName],[OceanBillofLadingNo],[ConveyanceRefNo],[TransportId],[FlightNO],[AircraftRegNo],[MasterAirwayBill],[ReleaseLocation],[RecepitLocation],[TotalOuterPack],[TotalOuterPackUOM],[TotalGrossWeight],[TotalGrossWeightUOM],[GrossReference],[BlanketStartDate],[Status],[TouchUser],[TouchTime]) Values ('" + JobNo + "','" + MsgNO + "','" + txt_code.Text + "','" + TxtTradeMailID.Text + "','" + TxtMsgType.Text + "','" + DrpDecType.SelectedItem.ToString() + "','" + DrpCargoPackType.SelectedItem.ToString() + "','" + DrpInwardtrasMode.SelectedItem.ToString() + "','" + DrpBGIndicator.SelectedItem.ToString() + "','" + ChkSupplyIndicator.Checked.ToString() + "','" + ChkRefDoc.Checked.ToString() + "','" + License + "','" + Recipient + "','" + TxtDecCompCode.Text + "','" + TxtImpCode.Text + "','" + InwardCode.Text + "','" + FrieghtCode.Text + "','" + ClaimantName.Text + "','" + ArrivalDate + "','" + TxtLoadShort.Text + "','" + TxtVoyageno.Text + "','" + TxtVesselName.Text + "','" + TxtOceanBill.Text + "','" + TxtConRefNo.Text + "','" + TxtTrnsID.Text + "','" + txtflight.Text + "','" + txtaircraft.Text + "','" + txtwaybill.Text + "','" + txtreLoctn.Text + "','" + txtrecloctn.Text + "','" + TxttotalOuterPack.Text + "','" + DrptotalOuterPack.SelectedItem.ToString() + "','" + TxtTotalGrossWeight.Text + "','" + DrpTotalGrossWeight.SelectedItem.ToString() + "','" + TxtGrossReference.Text + "','" + BlanketDate + "','DRF','" + Touch_user + "','" + strTime + "')");
            chkCode = obj.exec(StrQuery);
            if (chkCode == -2146232060)
            {
                        ...
                        if (ErrorDes == "")
                        {
                            ...
                            if (DrpDecType.SelectedItem.ToString() == "BKT : Blanket")
                            {
                                ...
                                else
                                {
                                    ...
                                    //string bd = Convert.ToDateTime(BlanketDate).ToString("yyyy-MM-dd HH:mm:ss");
                                    Save:
                                        string StrQuery = (" INSERT INTO [dbo].[InHeaderTbl] ([Refid],[JobId],[MSGId],[PermitId],[TradeNetMailboxID],[MessageType],[DeclarationType],[PreviousPermit],[CargoPackType],[InwardTransportMode],[BGIndicator],[SupplyIndicator],[ReferenceDocuments],[License],[Recipient],[DeclarantCompanyCode],[ImporterCompanyCode],[InwardCarrierAgentCode],[FreightForwarderCode],[ClaimantPartyCode],HBL,[ArrivalDate],[LoadingPortCode],[VoyageNumber],[VesselName],[OceanBillofLadingNo],[ConveyanceRefNo],[TransportId],[FlightNO],[AircraftRegNo],[MasterAirwayBill],[ReleaseLocation],ReleaseLocName,[RecepitLocation],[RecepitLocName],[TotalOuterPack],[TotalOuterPackUOM],[TotalGrossWeight],[TotalGrossWeightUOM],[GrossReference],[BlanketStartDate],[TradeRemarks],[InternalRemarks],[CustomerRemarks],[Status],[prmtStatus],[TouchUser],[TouchTime],[DeclareIndicator],[NumberOfItems],[TotalCIFFOBValue],[TotalGSTTaxAmt],[TotalExDutyAmt],[TotalCusDutyAmt],[TotalODutyAmt],[TotalAmtPay],[Cnb]) Values ('" + refno + "','" + JobNo + "','" + MsgNO + "','" + txt_code.Text + "','" + TxtTradeMailID.Text + "','" + TxtMsgType.Text + "','" + DrpDecType.SelectedItem.ToString() + "','" + TxtPrevPerNO.Text + "','" + DrpCargoPackType.SelectedItem.ToString() + "','" + DrpInwardtrasMode.SelectedItem.ToString() + "','" + DrpBGIndicator.SelectedItem.ToString() + "','" + ChkSupplyIndicator.Checked.ToString().ToLower() + "','" + ChkRefDoc.Checked.ToString().ToLower() + "','" + License + "','" + Recipient + "','" + TxtDecCompCode.Text + "','" + TxtImpCode.Text + "','" + InwardCode.Text + "','" + FrieghtCode.Text + "','" + ClaimantName.Text + "','" + txthBlCargo.Text + "','" + Convert.ToDateTime(ArrivalDate).ToString("yyyy/MM/dd") + "','" + TxtLoadShort.Text + "','" + TxtVoyageno.Text + "','" + TxtVesselName.Text + "','" + TxtOceanBill.Text + "','" + TxtConRefNo.Text + "','" + TxtTrnsID.Text + "','" + txtflight.Text + "','" + txtaircraft.Text + "','" + txtwaybill.Text + "','" + txtreLoctn.Text + "','" + txtrelocDeta.Text + "','" + txtrecloctn.Text + "','" + txtrecloctndet.Text + "','" + TxttotalOuterPack.Text + "','" + DrptotalOuterPack.SelectedItem.ToString() + "','" + TxtTotalGrossWeight.Text + "','" + DrpTotalGrossWeight.SelectedItem.ToString() + "','" + TxtGrossReference.Text + "','" + Convert.ToDateTime(BlanketDate).ToString("yyyy/MM/dd") + "','" + txttrdremrk.Text + "','" + txtintremrk.Text + "','" + txtcusRemrk.Text + "','NEW','NEW','" + Touch_user + "','" + strTime + "','" + chkDeclareInd.Checked.ToString().ToLower() + "','" + txtnoofitm.Text + "','" + txtfobval.Text + "','" + txttotgstAmt.Text + "','" + txttotexAmt.Text + "','" + txtcusdutyAmt.Text + "','" + txtothtaxAmt.Text + "','" + txtAmtPayble.Text + "','" + chkcnb.Checked.ToString() + "')");
                                        // string StrQuery = (" INSERT INTO [dbo].[InHeaderTbl] ([JobId],[MSGId],[PermitId],[TradeNetMailboxID],[MessageType],[DeclarationType],[CargoPackType],[InwardTransportMode],[BGIndicator],[SupplyIndicator],[ReferenceDocuments],[License],[Recipient],[DeclarantCompanyCode],[ImporterCompanyCode],[InwardCarrierAgentCode],[FreightForwarderCode],[ClaimantPartyCode],[ArrivalDate],[LoadingPortCode],[VoyageNumber],[VesselName],[OceanBillofLadingNo],[ConveyanceRefNo],[TransportId],[FlightNO],[AircraftRegNo],[MasterAirwayBill],[ReleaseLocation],[RecepitLocation],[TotalOuterPack],[TotalOuterPackUOM],[TotalGrossWeight],[TotalGrossWeightUOM],[GrossReference],[BlanketStartDate],[Status],[TouchUser],[TouchTime]) Values ('" + JobNo + "','" + MsgNO + "','" + txt_code.Text + "','" + TxtTradeMailID.Text + "','" + TxtMsgType.Text + "','" + DrpDecType.SelectedItem.ToString() + "','" + DrpCargoPackType.SelectedItem.ToString() + "','" + DrpInwardtrasMode.SelectedItem.ToString() + "','" + DrpBGIndicator.SelectedItem.ToString() + "','" + ChkSupplyIndicator.Checked.ToString() + "','" + ChkRefDoc.Checked.ToString() + "','" + License + "','" + Recipient + "','" + TxtDecCompCode.Text + "','" + TxtImpCode.Text + "','" + InwardCode.Text + "','" + FrieghtCode.Text + "','" + ClaimantName.Text + "','" + ArrivalDate + "','" + TxtLoadShort.Text + "','" + TxtVoyageno.Text + "','" + TxtVesselName.Text + "','" + TxtOceanBill.Text + "','" + TxtConRefNo.Text + "','" + TxtTrnsID.Text + "','" + txtflight.Text + "','" + txtaircraft.Text + "','" + txtwaybill.Text + "','" + txtreLoctn.Text + "','" + txtrecloctn.Text + "','" + TxttotalOuterPack.Text + "','" + DrptotalOuterPack.SelectedItem.ToString() + "','" + TxtTotalGrossWeight.Text + "','" + DrpTotalGrossWeight.SelectedItem.ToString() + "','" + TxtGrossReference.Text + "','" + BlanketDate + "','DRF','" + Touch_user + "','" + strTime + "')");
                                        chkCode = obj.exec(StrQuery);
                                        if (chkCode == -2146232060)
                                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    //string bd = Convert.ToDateTime(BlanketDate).ToString("yyyy-MM-dd HH:mm:ss");
                                    Save:
                                        string StrQuery = (" INSERT INTO [dbo].[InHeaderTbl] ([Refid],[JobId],[MSGId],[PermitId],[TradeNetMailboxID],[MessageType],[DeclarationType],[PreviousPermit],[CargoPackType],[InwardTransportMode],[BGIndicator],[SupplyIndicator],[ReferenceDocuments],[License],[Recipient],[DeclarantCompanyCode],[ImporterCompanyCode],[InwardCarrierAgentCode],[FreightForwarderCode],[ClaimantPartyCode],HBL,[ArrivalDate],[LoadingPortCode],[VoyageNumber],[VesselName],[OceanBillofLadingNo],[ConveyanceRefNo],[TransportId],[FlightNO],[AircraftRegNo],[MasterAirwayBill],[ReleaseLocation],ReleaseLocName,[RecepitLocation],[RecepitLocName],[TotalOuterPack],[TotalOuterPackUOM],[TotalGrossWeight],[TotalGrossWeightUOM],[GrossReference],[BlanketStartDate],[TradeRemarks],[InternalRemarks],[CustomerRemarks],[Status],[prmtStatus],[TouchUser],[TouchTime],[DeclareIndicator],[NumberOfItems],[TotalCIFFOBValue],[TotalGSTTaxAmt],[TotalExDutyAmt],[TotalCusDutyAmt],[TotalODutyAmt],[TotalAmtPay]) Values ('" + refno + "','" + JobNo + "','" + MsgNO + "','" + txt_code.Text + "','" + TxtTradeMailID.Text + "','" + TxtMsgType.Text + "','" + DrpDecType.SelectedItem.ToString() + "','" + TxtPrevPerNO.Text + "','" + DrpCargoPackType.SelectedItem.ToString() + "','" + DrpInwardtrasMode.SelectedItem.ToString() + "','" + DrpBGIndicator.SelectedItem.ToString() + "','" + ChkSupplyIndicator.Checked.ToString().ToLower() + "','" + ChkRefDoc.Checked.ToString().ToLower() + "','" + License + "','" + Recipient + "','" + TxtDecCompCode.Text + "','" + TxtImpCode.Text + "','" + InwardCode.Text + "','" + FrieghtCode.Text + "','" + ClaimantName.Text + "','" + txthBlCargo.Text + "','" + Convert.ToDateTime(ArrivalDate).ToString("yyyy/MM/dd") + "','" + TxtLoadShort.Text + "','" + TxtVoyageno.Text + "','" + TxtVesselName.Text + "','" + TxtOceanBill.Text + "','" + TxtConRefNo.Text + "','" + TxtTrnsID.Text + "','" + txtflight.Text + "','" + txtaircraft.Text + "','" + txtwaybill.Text + "','" + txtreLoctn.Text + "','" + txtrelocDeta.Text + "','" + txtrecloctn.Text + "','" + txtrecloctndet.Text + "','" + TxttotalOuterPack.Text + "','" + DrptotalOuterPack.SelectedItem.ToString() + "','" + TxtTotalGrossWeight.Text + "','" + DrpTotalGrossWeight.SelectedItem.ToString() + "','" + TxtGrossReference.Text + "','" + Convert.ToDateTime(BlanketDate).ToString("yyyy/MM/dd") + "','" + txttrdremrk.Text + "','" + txtintremrk.Text + "','" + txtcusRemrk.Text + "','NEW','NEW','" + Touch_user + "','" + strTime + "','" + chkDeclareInd.Checked.ToString().ToLower() + "','" + txtnoofitm.Text + "','" + txtfobval.Text + "','" + txttotgstAmt.Text + "','" + txttotexAmt.Text + "','" + txtcusdutyAmt.Text + "','" + txtothtaxAmt.Text + "','" + txtAmtPayble.Text + "')");
                                        // string StrQuery = (" INSERT INTO [dbo].[InHeaderTbl] ([JobId],[MSGId],[PermitId],[TradeNetMailboxID],[MessageType],[DeclarationType],[CargoPackType],[InwardTransportMode],[BGIndicator],[SupplyIndicator],[ReferenceDocuments],[License],[Recipient],[DeclarantCompanyCode],[ImporterCompanyCode],[InwardCarrierAgentCode],[FreightForwarderCode],[ClaimantPartyCode],[ArrivalDate],[LoadingPortCode],[VoyageNumber],[VesselName],[OceanBillofLadingNo],[ConveyanceRefNo],[TransportId],[FlightNO],[AircraftRegNo],[MasterAirwayBill],[ReleaseLocation],[RecepitLocation],[TotalOuterPack],[TotalOuterPackUOM],[TotalGrossWeight],[TotalGrossWeightUOM],[GrossReference],[BlanketStartDate],[Status],[TouchUser],[TouchTime]) Values ('" + JobNo + "','" + MsgNO + "','" + txt_code.Text + "','" + TxtTradeMailID.Text + "','" + TxtMsgType.Text + "','" + DrpDecType.SelectedItem.ToString() + "','" + DrpCargoPackType.SelectedItem.ToString() + "','" + DrpInwardtrasMode.SelectedItem.ToString() + "','" + DrpBGIndicator.SelectedItem.ToString() + "','" + ChkSupplyIndicator.Checked.ToString() + "','" + ChkRefDoc.Checked.ToString() + "','" + License + "','" + Recipient + "','" + TxtDecCompCode.Text + "','" + TxtImpCode.Text + "','" + InwardCode.Text + "','" + FrieghtCode.Text + "','" + ClaimantName.Text + "','" + ArrivalDate + "','" + TxtLoadShort.Text + "','" + TxtVoyageno.Text + "','" + TxtVesselName.Text + "','" + TxtOceanBill.Text + "','" + TxtConRefNo.Text + "','" + TxtTrnsID.Text + "','" + txtflight.Text + "','" + txtaircraft.Text + "','" + txtwaybill.Text + "','" + txtreLoctn.Text + "','" + txtrecloctn.Text + "','" + TxttotalOuterPack.Text + "','" + DrptotalOuterPack.SelectedItem.ToString() + "','" + TxtTotalGrossWeight.Text + "','" + DrpTotalGrossWeight.SelectedItem.ToString() + "','" + TxtGrossReference.Text + "','" + BlanketDate + "','DRF','" + Touch_user + "','" + strTime + "')");
                                        chkCode = obj.exec(StrQuery);
                                        if (chkCode == -2146232060)
                                        {
        ...
        protected void ClaimantGrid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                if (row != null)
                {
                    var lblCode1 = row.FindControl("lblname") as Label;
                    var lblName1 = row.FindControl("lblName1") as Label;
                    var lblName11 = row.FindControl("lblCRUEI") as Label;
                    var cruei1 = row.FindControl("lblCName") as Label;
        ...
        protected void txtlsp_TextChanged(object sender, EventArgs e)
        {
            if (txtlsp.Text != "")
            {
                ...
                T6 = ((T4 * 0.07) + (T5 * 0.07) + (T7 * 0.07) + (T8 * 0.07));
        ...
        private void BindCondition()
        {
            ...
            string qry112Q = "SELECT * FROM InPMT where PermitNumber='" + Permitnum + "'";
            obj.dr = obj.ret_dr(qry112Q);
            if (obj.dr.Read())
            {
            ...
            //{
            //    InpaymentClass obj1 = new InpaymentClass();
            //    obj1.dr = obj1.ret_dr("Select * from InHeadertbl Where PermitNumber='" + Permitnum + "'");
            //    if (obj1.dr.Read())
            //    {
            ...
            string constr = ConfigurationManager.ConnectionStrings["Mycon"].ConnectionString;
            string status = "";
            InpaymentClass select = new InpaymentClass();
            obj.dr = obj.ret_dr("Select * from InHeadertbl Where MSGId='" + msgid + "'");
            ...
            if (status == "APR")
            {
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNO , ConditionCode as Code, ConditionDescription  as Description  FROM InPMT Where PermitNumber='" + Permitnum + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "ERR")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT  Sno as SNO, ErrorCode as ErrorCode, ErrorDescription+' '+ErrorTrace as Description FROM ErrorStatus Where MsgID='" + msgid + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "REJ")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT  Sno as SNO, ErrorID as  Code  ,ErrorDescription as Description FROM RejectStatus Where MsgID='" + msgid + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "CNL")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNO, ConditionCde  as Code , ConditionDes as Description FROM InCancel Where MsgID='" + msgid + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "AME")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNO, ConditionCode  as Code , ConditionDescription as Description FROM InAMDPMT Where PermitNumber='" + Permitnum + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
                  ...
                  //  }
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        if (row["Item Number"].ToString() != "")
                        {
                            ...
                            string StrQuery1 = ("INSERT INTO [dbo].[CASCDtl] (ItemNo,[ProductCode],[Quantity],[ProductUOM],[RowNo],[CascCode1],[CascCode2],[CascCode3],[PermitId],[MessageType],[TouchUser],[TouchTime] ,[CASCId]) VALUES ('" + row["Item Number"].ToString() + "','" + nullval + "','" + DecimalVal + "','" + uom + "','" + p1 + "','" + row["Code 1"].ToString() + "','" + row["Code 2"].ToString() + "','" + row["Code 3"].ToString() + "','" + PermitId + "','" + Messagetype + "','" + Touch_user + "','" + strTime + "','" + row["CascID"].ToString() + "')");
                            obj.exec(StrQuery1);
                            p1++;
                        }
                        obj.closecon();
