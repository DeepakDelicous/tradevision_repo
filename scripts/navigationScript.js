...
function toggleDropdown(element) {
  if (element.nextElementSibling.classList.contains("h-0")) {
    ...
    element.nextElementSibling.classList.add("pt-1");
  ...
  element.nextElementSibling.classList.remove("pt-1");
...
links.forEach((link) => {
  if (link.attributes.href.value == location.pathname) {
    ...
    link.children[0].classList.add("text-[#0560FD]", "bg-blue-100");
    // console.log(
...
notify.forEach((e) => {
  ...
  e.btn.addEventListener("click", () => {
    ...
    if (e.list.classList.contains("active")) {
      e.btn.classList.add("bg-[#f2f7ff]");
      e.btn.classList.add("text-[#0560FD]");
    ...
    notify.forEach((y) => {
      if (y.list.classList.contains("active") && y != e) {
        y.btn.classList.remove("bg-[#f2f7ff]");
        y.btn.classList.remove("text-[#0560FD]");
