...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-full xl:ml-[0px]">
        ...
        <!-- MainPage -->
        <div class="px-6 py-6 xl:max-w-[1150px] fixw w-full mx-auto">
          <!-- Page Heading -->
          <div
          ...
          >
            <!-- card 1 -->
            <div
              class="bg-white px-6 py-4 flex flex-col justify-center items-start my-shadow rounded-2xl md:w-[205px] w-full h-[120px]"
            >
          ...
          >
            ...
            <div
              class="lg:max-w-[650px] w-full lg:h-[380px] px-6 py-6 bg-white my-shadow flex flex-col justify-center rounded-2xl"
            >
              <div
        ...
        -->
          ...
          <div class="flex lg:flex-row flex-col-reverse items-center w-full lg:items-stretch justify-center lg:justify-between gap-4 mt-4 rounded-2xl">
            <!-- Table -->
            <div
              class="overflow-auto my-shadow whitespace-nowrap bg-white rounded-2xl p-6 lg:max-w-[650px] w-full"
            >
