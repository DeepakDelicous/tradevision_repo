...
namespace RET
{
    public partial class AdminCreateList : System.Web.UI.Page
    {
        ...
        private void BindAdmin()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("SELECT * FROM AdminCreate"))
                {
        ...
        protected void InpaymentEdit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string ID = ID1.Text;
            Response.Redirect("AdminCreate.aspx?ID=" + ID);
        }
    }
}