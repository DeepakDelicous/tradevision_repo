<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="InNONpaymentList.aspx.cs" Inherits="RET.InNONpaymentList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link href="css/style.css?abc=12" rel="stylesheet" />
    ...
    <div class="flex gap-y-3 items-center justify-between flex-wrap">
        ...
        <div>
            <h1 class="text-2xl sa700 leading-normal text-gray-800">In Non-Payment
              </h1>
        </div>
        <div class="flex items-center gap-4 lg:flex-nowrap flex-wrap">
            ...
            <a href="InNonPayment.aspx" id="Inpay" runat="server" class="hover:no-underline  w-full  md:w-[160px]">
    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional" class="amend-options">
        <ContentTemplate>
            <div id="ACR" runat="server" visible="false" class="flex gap-x-2 items-center justify-end mt-[20.5px]">
                <asp:Label runat="server" ID="LB" class="text-1xl sa760 leading-normal text-gray-700" Text="AMEND/CANCEL"></asp:Label>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
       ...
       <asp:LinkButton OnClick="View_Click" data-target='<%#"#"+DataBinder.Eval(Container.DataItem,"Id")%>' Width="16" Height="16" ID="LinkButton3" runat="server"><img src="images/eye-open.svg" /> </asp:LinkButton>
                                ...
                                <asp:TemplateField HeaderText="JobId" SortExpression="JobId" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500  px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                         <p class="text-slate-500 text-xs font-medium py-3 px-2">
     <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtJobId" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtJobId_TextChanged1" Text='<%# Bind("JobId") %>'>
     </asp:TextBox>
 </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="InHAWBOBL" SortExpression="InHAWBOBL" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblInHAWBOBL" runat="server" Text='<%#Eval("Inhabl")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                               ...
                               <%-- <asp:TemplateField HeaderText="TermType" SortExpression="TermType" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  ID="txtTermType" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtTermType_TextChanged" Text='<%# Bind("TermType") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>--%>
