...
namespace RET
{
    public partial class InNonPaymentView : System.Web.UI.Page
    {        
        ...
        public static string uom, exrate, exuom, crate, cuom, kgmvis, Permitno, msgid;
        ...
        {            
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 * from  Importer where Code like '" + prefixText + "%' ", sqlconn);
        ...
        {            
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 * from  InnonInwardCarrierAgent where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Name", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        {            
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 * from  FreightForwarder where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Name", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        {            
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 * from  InnonOutwardCarrierAgent where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Name", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        {            
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 * from  InnonClaimantParty where Name like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Name", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        {            
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 * from  InnonConsignee where ConsigneeCode like '" + prefixText + "%' ", sqlconn);
        ...
        {            
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 5 * from  InnonExporter where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Code", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        public static List<string> GetStrgLoc(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select Top 10 Code,Description from  StorageLocation where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Description", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet dsrecl = new DataSet();
                //DataTable dt = new DataTable();
        ...
        public static List<string> Getsupcode(string prefixText)
        {
            ...
            {
                sqlconn.Open();
                SqlCommand cmd = new SqlCommand("select * from  INNONSUPPLIERMANUFACTURERPARTY where Code like '" + prefixText + "%' ", sqlconn);
                cmd.Parameters.AddWithValue("@Name", prefixText);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        {
            string qry112Q = "SELECT * FROM InnonPMT where PermitNumber='" + Permitnum + "'";
            ...
            //{
            //    InnonPaymentClass obj1 = new InnonPaymentClass();
            //    obj1.dr = obj1.ret_dr("Select * from InNonHeaderTbl Where PermitNumber='" + Permitnum + "'");
            //    if (obj1.dr.Read())
            //    {
            ...
            string status = "";
            InnonPaymentClass select = new InnonPaymentClass();
            obj.dr = obj.ret_dr("Select * from InNonHeaderTbl Where  MSGId='" + msgid + "'");
            if (obj.dr.Read())
            {
            ...
            if (status == "APR")
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNO , ConditionCode as Code, ConditionDescription  as Description  FROM  InnonPMT where PermitNumber='" + Permitnum + "'"))
                    {
            ...
            else if (status == "ERR")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT  Sno as SNO, ErrorCode as ErrorCode, ErrorDescription+' '+ErrorTrace as Description FROM InnonErrorStatus where MsgID='" + msgid + "'"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "REJ")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT  Sno as SNO, ErrorID as  Code  , ErrorDescription as Description FROM InnonRejectStatus where MsgID='" + msgid + "'"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "CNL")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNO, ConditionCde  as Code , ConditionDes as Description FROM InnonCancelPermit Where MsgID='" + msgid + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            else if (status == "AME")
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT Sno as SNO, ConditionCode  as Code , ConditionDescription as Description FROM InnonAMDPMT Where PermitNumber='" + Permitnum + "' order by Sno"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            cmd.Connection = con;
            ...
            //string qry112Q = "SELECT * FROM InnonPMT where PermitNumber='" + Permitno + "'";
            //obj.dr = obj.ret_dr(qry112Q);
            //while (obj.dr.Read())
            //{
            //    LblPermitNo.Text = obj.dr["PermitNumber"].ToString();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //TDQ
                string str7 = "select Top 20 Id,Currency from [Currency]  order by Currency";
        ...
        private void editCPCAEO()
        {
            SqlConnection con = new SqlConnection(sqlconn);
            //SqlCommand cmd1 = new SqlCommand("SELECT T1.Id ,T1.CRP,T1.CompanyName,T1.Name,T1.EmailId,T1.Mobile, T2.Name as Rent ,t1.BudgetFrom,T1.BudgetTo ,T3.Name as Type,T4.Name as Location,T5.PropertyRef,T1.MultipleLocation,T1. MultipleProperty  FROM (select a.Id,a.CompanyName,a.Name,a.EmailId,a.Mobile,a.BudgetFrom,a.BudgetTo,b.Name as CRP,a.MultipleLocation,a.MultipleProperty  from lead a,CommonMaster b where a.Per_Com=b.Id and a.TouchUser='" + Touch_user + "') AS T1 JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.RentorBuy=b.Id) AS T2    ON T1.Id = T2.Id    JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Type=b.Id) AS T3  ON T1.Id = T3.Id     JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Location=b.Id) AS T4   ON T1.Id = T4.Id    JOIN ( select b.ID,b.Name,a.PropertyRef  from Lead_List a,Lead b where a.ParentId=b.Id) AS T5   ON T1.Id = T5.Id order by T1.Id desc", con);
            SqlCommand cmd1 = new SqlCommand("select RowNo as RowNumber,ProcessingCode1,ProcessingCode2,ProcessingCode3 from InNonHeaderTbl a,InNonCPCDtl b where a.PermitId=b.PermitId and b.CPCType='AEO' and a.PermitId='" + txt_code.Text + "'", con);
            SqlDataAdapter sda1 = new SqlDataAdapter(cmd1);
            DataTable dt = new DataTable();
            sda1.Fill(dt);
            if (dt.Rows.Count <= 0)
        ...
        private void editCPCcwc()
        {
            SqlConnection con = new SqlConnection(sqlconn);
            //SqlCommand cmd1 = new SqlCommand("SELECT T1.Id ,T1.CRP,T1.CompanyName,T1.Name,T1.EmailId,T1.Mobile, T2.Name as Rent ,t1.BudgetFrom,T1.BudgetTo ,T3.Name as Type,T4.Name as Location,T5.PropertyRef,T1.MultipleLocation,T1. MultipleProperty  FROM (select a.Id,a.CompanyName,a.Name,a.EmailId,a.Mobile,a.BudgetFrom,a.BudgetTo,b.Name as CRP,a.MultipleLocation,a.MultipleProperty  from lead a,CommonMaster b where a.Per_Com=b.Id and a.TouchUser='" + Touch_user + "') AS T1 JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.RentorBuy=b.Id) AS T2    ON T1.Id = T2.Id    JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Type=b.Id) AS T3  ON T1.Id = T3.Id     JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Location=b.Id) AS T4   ON T1.Id = T4.Id    JOIN ( select b.ID,b.Name,a.PropertyRef  from Lead_List a,Lead b where a.ParentId=b.Id) AS T5   ON T1.Id = T5.Id order by T1.Id desc", con);
            SqlCommand cmd1 = new SqlCommand("select RowNo as RowNumber,ProcessingCode1,ProcessingCode2,ProcessingCode3 from InNonHeaderTbl a,InNonCPCDtl b where a.PermitId=b.PermitId and b.CPCType='CWC' and a.PermitId='" + txt_code.Text + "'", con);
            SqlDataAdapter sda1 = new SqlDataAdapter(cmd1);
            DataTable dt = new DataTable();
            sda1.Fill(dt);
            if (dt.Rows.Count <= 0)
        ...
        private void editCPCSeastore()
        {
            SqlConnection con = new SqlConnection(sqlconn);
            //SqlCommand cmd1 = new SqlCommand("SELECT T1.Id ,T1.CRP,T1.CompanyName,T1.Name,T1.EmailId,T1.Mobile, T2.Name as Rent ,t1.BudgetFrom,T1.BudgetTo ,T3.Name as Type,T4.Name as Location,T5.PropertyRef,T1.MultipleLocation,T1. MultipleProperty  FROM (select a.Id,a.CompanyName,a.Name,a.EmailId,a.Mobile,a.BudgetFrom,a.BudgetTo,b.Name as CRP,a.MultipleLocation,a.MultipleProperty  from lead a,CommonMaster b where a.Per_Com=b.Id and a.TouchUser='" + Touch_user + "') AS T1 JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.RentorBuy=b.Id) AS T2    ON T1.Id = T2.Id    JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Type=b.Id) AS T3  ON T1.Id = T3.Id     JOIN ( select a.ID,b.Name from lead a,CommonMaster b where a.Location=b.Id) AS T4   ON T1.Id = T4.Id    JOIN ( select b.ID,b.Name,a.PropertyRef  from Lead_List a,Lead b where a.ParentId=b.Id) AS T5   ON T1.Id = T5.Id order by T1.Id desc", con);
            SqlCommand cmd1 = new SqlCommand("select RowNo as RowNumber,ProcessingCode1,ProcessingCode2,ProcessingCode3 from InNonHeaderTbl a,InNonCPCDtl b where a.PermitId=b.PermitId and b.CPCType='SEASTORE' and a.PermitId='" + txt_code.Text + "'", con);
            SqlDataAdapter sda1 = new SqlDataAdapter(cmd1);
            DataTable dt = new DataTable();
            sda1.Fill(dt);
            if (dt.Rows.Count <= 0)
        ...
        private void EditDocument()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("select * from InNonFile where InPaymentId='" + MsgNO + "'"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        cmd.Connection = con;
        ...
        private void BindGrid()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("SELECT Id,DocumentType,Name FROM InNonFile where  InPaymentId='" + MsgNO + "'"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        cmd.Connection = con;
        ...
        protected void TxtImpCode_TextChanged(object sender, EventArgs e)
        {
            if (TxtImpCode.Text != "")
            {
                ...
                string qry11 = "select Top 1 * from Importer where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
                    TxtImpCode.Text = obj.dr[1].ToString();
        ...
        protected void InwardAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                string Code = "";
                string qry11 = "SELECT Code FROM InnonInwardCarrierAgent where Code='" + InwardCode.Text + "'";
                ...
                if (Code == "")
                {
                    ...
                    string strTime = System.DateTime.Now.ToString("yyyy/MM/dd");
                    string StrQuery = ("INSERT INTO [dbo].[InnonInwardCarrierAgent] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + InwardCode.Text + "','" + InwardName.Text + "','" + InwardName1.Text + "','" + InwardCRUEI.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                    obj.exec(StrQuery);
                    BindInward();
                }
                else
        ...
        public DataTable GetInwardDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM InnonInwardCarrierAgent where Code Like '%" + InwardSearch.Text + "%' or Name Like '%" + InwardSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void InwardCode_TextChanged(object sender, EventArgs e)
        {
            if (InwardCode.Text != "")
            {
                ...
                string qry11 = "select Top 1 * from InnonInwardCarrierAgent where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
                    InwardCode.Text = obj.dr[1].ToString();
        ...
        public DataTable GetFreightDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM FreightForwarder where Code Like '%" + FrieghtSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void FrieghtCode_TextChanged(object sender, EventArgs e)
        {
            ...
            if (FrieghtCode.Text != "")
            {
                ...
                string qry11 = "select Top 1 * from FreightForwarder where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
                    FrieghtCode.Text = obj.dr[1].ToString();
        ...
        protected void FrieghtGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popupinnonfreight.X = 400;
            popupinnonfreight.Y = 100;
            BindFrieght();
        }
        ...
        protected void LoadingGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popupinnonloadingport.X = 400;
            popupinnonloadingport.Y = 100;
            BindLoading();
        }
        ...
        protected void LocationSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            popupinnonreleaseloction.X = 400;
            popupinnonreleaseloction.Y = 100;
        }
        ...
        protected void ReceiptSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            popupinnonreceiptlocation.X = 400;
            popupinnonreceiptlocation.Y = 100;
        }
        public DataTable GetReceipt(string searchtext)
        {
            ...
            string str3 = "SELECT * FROM ReceiptLocation where Code Like '%" + ReceiptSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void txtcodeinvq_TextChanged(object sender, EventArgs e)
        {
            if (txtcodeinvq.Text != "")
            {
                ...
                string qry11 = "select * from INNONSUPPLIERMANUFACTURERPARTY where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
                ...
                using (Stream fs = postedFile.InputStream)
                {
                    using (BinaryReader br = new BinaryReader(fs))
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(constr))
                        {
                            ...
                            string strTime = System.DateTime.Now.ToString("yyyy/MM/dd");
                            string query = "insert into InNonFile values (@Sno,@Name, @ContentType, @Data,@DocumentType,@InPaymentId,@TouchUser,@TouchTime)";
        ...
        {
            DataTable _objdt = new DataTable();
            _objdt = GetHSCodeFromDataBase(HSCodeSearchItem.Text);
            if (_objdt.Rows.Count > 0)
            {
        ...
        private void BindInvoice()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("SELECT Top 20 * FROM InNonInvoiceDtl where PermitId='" + txt_code.Text + "' and MessageType='INPDEC' order by Id"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        cmd.Connection = con;
        ...
        protected void TxtTotalLineAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            summerygst = (sumex * 0.07) + (cif * 0.07) + (optional * 0.07);
        ...
        protected void BtnItemAdd_Click(object sender, EventArgs e)
        {
            ...
            if (MaxItemCount != "50")
            {
                ...
                if (Code == "")
                {
                    ...
                    string StrQuery1 = ("INSERT INTO [dbo].[InNonItemDtl] ([ItemNo],[PermitId],[MessageType],[HSCode],[Description],[DGIndicator],[Contry],[Brand],[Model],[Vehicletype],[Enginecapacity],[Engineuom],[Orginregdate],[InHAWBOBL],[OutHAWBOBL],[DutiableQty],[DutiableUOM],[TotalDutiableQty],[TotalDutiableUOM],[InvoiceQuantity],[HSQty],[HSUOM],[AlcoholPer],[InvoiceNo],[UnitPrice],[UnitPriceCurrency],[ExchangeRate],[SumExchangeRate],[TotalLineAmount],[InvoiceCharges],[CIFFOB],[OPQty],[OPUOM],[IPQty],[IPUOM],[InPqty],[InPUOM],[ImPQty],[ImPUOM],[PreferentialCode],[GSTRate],[GSTUOM],[GSTAmount],[ExciseDutyRate],[ExciseDutyUOM],[ExciseDutyAmount],[CustomsDutyRate],[CustomsDutyUOM],[CustomsDutyAmount],[OtherTaxRate],[OtherTaxUOM],[OtherTaxAmount],[CurrentLot],[PreviousLot],LSPValue,[Making],[ShippingMarks1],[ShippingMarks2],[ShippingMarks3],[ShippingMarks4],[OptionalChrgeUOM],[Optioncahrge],[OptionalSumtotal],[OptionalSumExchage],[TouchUser],[TouchTime]) VALUES ('" + TxtSerialNo.Text + "','" + txt_code.Text + "','" + TxtMsgType.Text + "','" + TxtHSCodeItem.Text + "','" + TxtDescription.Text + "','" + ChkBGIndicator.Checked.ToString() + "','" + TxtCountryItem.Text + "','" + TxtBrand.Text + "','" + TxtModel.Text + "','" + DrpVehicleType.SelectedItem.Text + "','" + txtengine.Text + "','" + DrpVehicleCapacity.SelectedItem.Text + "','" + Convert.ToDateTime(orgindate).ToString("yyyy/MM/dd") + "','" + TxtHAWB.SelectedItem.ToString() + "','" + txtOutHAWB1.SelectedItem.ToString() + "','" + TxtTotalDutiableQuantity.Text + "','" + TDQUOM.SelectedItem.ToString() + "','" + txttotDutiableQty.Text + "','" + ddptotDutiableQty.SelectedItem.ToString() + "','" + TxtInvQty.Text + "','" + TxtHSQuantity.Text + "','" + HSQTYUOM.SelectedItem.Text + "','" + txtAlcoholPer.Text + "','" + DrpInvoiceNo.SelectedItem.Text + "','" + TxtUnitPrice.Text + "','" + DRPCurrency.SelectedItem.Text + "','" + TxtExchangeRate.Text + "','" + TxtSumExRate.Text + "','" + Convert.ToDecimal(TxtTotalLineAmount.Text).ToString() + "','" + Convert.ToDecimal(TxtTotalLineCharges.Text).ToString() + "','" + Convert.ToDecimal(TxtCIFFOB.Text).ToString() + "','" + TxtOPQty.Text + "','" + DRPOPQUOM.SelectedItem.Text + "','" + TxtIPQty.Text + "','" + DRPIPQUOM.SelectedItem.Text + "','" + TxtINPQty.Text + "','" + DRPINNPQUOM.SelectedItem.Text + "','" + TxtIMPQty.Text + "','" + DRPIMPQUOM.SelectedItem.Text + "','" + DrpPreferentialCode.SelectedItem.Text + "','" + ItemGSTRate.Text + "','" + ItemGSTUOM.Text + "','" + Convert.ToDecimal(TxtItemSumGST.Text).ToString() + "','" + TxtExciseDutyRate.Text + "','" + TxtExciseDutyUOM.Text + "','" + TxtSumExciseDuty.Text + "','" + TxtCustomsDutyRate.Text + "','" + TxtCustomsDutyUOM.Text + "','" + TxtSumCustomsDuty.Text + "','" + TxtOtherTaxRate.Text + "','" + DrpOtherUOM.SelectedItem.Text + "','" + TxtSumOtherTaxRate.Text + "','" + TxtCurrentLot.Text + "','" + TxtPreviousLot.Text + "','" + txtlsp.Text + "','" + DrpMaking.SelectedItem.Text + "','" + txtShippingMarks1.Text + "','" + txtShippingMarks2.Text + "','" + txtShippingMarks3.Text + "','" + txtShippingMarks4.Text + "','" + DrpOptionalUom.SelectedItem.Text + "','" + TxtOptionalPrice.Text + "','" + TxtOptionalExchageRate.Text + "','" + TxtOptionalSumExRate.Text + "','" + Touch_user + "','" + strTime + "')");
                    obj.exec(StrQuery1);
                    obj.closecon();
                ...
                else
                {
                    ...
                    string StrQuery1 = ("update [dbo].[InNonItemDtl]  set [HSCode]='" + TxtHSCodeItem.Text + "',[Description]='" + TxtDescription.Text + "',[DGIndicator]='" + ChkBGIndicator.Checked.ToString() + "',[Contry]= '" + TxtCountryItem.Text + "',[Brand]='" + TxtBrand.Text + "',[Model]='" + TxtModel.Text + "',[Vehicletype]='" + DrpVehicleType.SelectedItem.Text + "',[Enginecapacity]='" + txtengine.Text + "',[Engineuom]='" + DrpVehicleCapacity.SelectedItem.Text + "',[Orginregdate]='" + Convert.ToDateTime(orgindate).ToString("yyyy/MM/dd") + "',[InHAWBOBL]='" + TxtHAWB.SelectedItem.ToString() + "',[OutHAWBOBL]='" + txtOutHAWB1.SelectedItem.ToString() + "',[DutiableQty]='" + TxtTotalDutiableQuantity.Text + "',[DutiableUOM]='" + TDQUOM.SelectedItem.Text + "',[TotalDutiableQty]='" + txttotDutiableQty.Text + "',[TotalDutiableUOM]='" + ddptotDutiableQty.SelectedItem.Text + "',[InvoiceQuantity]='" + TxtInvQty.Text + "',[HSQty]='" + TxtHSQuantity.Text + "', [HSUOM]='" + HSQTYUOM.SelectedItem.Text + "',[AlcoholPer]='" + txtAlcoholPer.Text + "',[InvoiceNo]='" + DrpInvoiceNo.SelectedItem.Text + "',[ChkUnitPrice]='" + ChkUnitPrice.Checked + "',[UnitPrice]='" + TxtUnitPrice.Text + "',[UnitPriceCurrency]='" + DRPCurrency.SelectedItem.Text + "',[ExchangeRate]='" + TxtExchangeRate.Text + "',[SumExchangeRate]='" + TxtSumExRate.Text + "',[TotalLineAmount]='" + TxtTotalLineAmount.Text + "',[InvoiceCharges]='" + TxtTotalLineCharges.Text + "',[CIFFOB]='" + TxtCIFFOB.Text + "',[OPQty]='" + TxtOPQty.Text + "',[OPUOM]='" + DRPOPQUOM.SelectedItem.Text + "',[IPQty]='" + TxtIPQty.Text + "',[IPUOM]='" + DRPIPQUOM.SelectedItem.Text + "',[InPqty]='" + TxtINPQty.Text + "',[InPUOM]='" + DRPINNPQUOM.SelectedItem.Text + "',[ImPQty]='" + TxtIMPQty.Text + "',[ImPUOM]='" + DRPIMPQUOM.SelectedItem.Text + "',[PreferentialCode]='" + DrpPreferentialCode.SelectedItem.Text + "',[GSTRate]='" + ItemGSTRate.Text + "',[GSTUOM]='" + ItemGSTUOM.Text + "',[GSTAmount]='" + TxtItemSumGST.Text + "',[ExciseDutyRate]='" + TxtExciseDutyRate.Text + "', [ExciseDutyUOM]='" + TxtExciseDutyUOM.Text + "',[ExciseDutyAmount]='" + TxtSumExciseDuty.Text + "',[CustomsDutyRate]='" + TxtCustomsDutyRate.Text + "',[CustomsDutyUOM]='" + TxtCustomsDutyUOM.Text + "',[CustomsDutyAmount]='" + TxtSumCustomsDuty.Text + "',[OtherTaxRate]='" + TxtOtherTaxRate.Text + "',[OtherTaxUOM]='" + DrpOtherUOM.SelectedItem.Text + "',[OtherTaxAmount]='" + TxtSumOtherTaxRate.Text + "',[CurrentLot]='" + TxtCurrentLot.Text + "',[PreviousLot]='" + TxtPreviousLot.Text + "',[Making]='" + DrpMaking.SelectedItem.Text + "',[ShippingMarks1]='" + txtShippingMarks1.Text + "',[ShippingMarks2]='" + txtShippingMarks2.Text + "',[ShippingMarks3]='" + txtShippingMarks3.Text + "',[ShippingMarks4]='" + txtShippingMarks4.Text + "',OptionalChrgeUOM='" + DrpOptionalUom.SelectedItem.Text + "',[Optioncahrge]='" + TxtOptionalPrice.Text + "',[OptionalSumtotal]='" + TxtOptionalExchageRate.Text + "',[OptionalSumExchage]='" + TxtOptionalSumExRate.Text + "',[TouchUser]='" + Touch_user + "',[TouchTime]='" + strTime + "' where  MessageType='INPDEC' AND PermitId='" + txt_code.Text + "' and ItemNo='" + TxtSerialNo.Text + "'");
                    obj.exec(StrQuery1);
                    obj.closecon();
        ...
        protected void OutwardAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                string Code = "";
                string qry11 = "SELECT Code FROM [InnonOutwardCarrierAgent] where Code='" + OutwardCode.Text + "'";
                ...
                if (Code == "")
                {
                    ...
                    string strTime = System.DateTime.Now.ToString("yyyy/MM/dd");
                    string StrQuery = ("INSERT INTO [dbo].[InnonOutwardCarrierAgent] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + OutwardCode.Text + "','" + OutwardName.Text + "','" + OutwardName1.Text + "','" + OutwardCRUEI.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                    obj.exec(StrQuery);
                    BindOutward();
                }
                else
        ...
        public DataTable GetOutwardDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Id,Code,Name,Name1,CRUEI FROM [InnonOutwardCarrierAgent] where Code Like '%" + OutwardSearch.Text + "%' or Name Like '%" + OutwardSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void OutwardCode_TextChanged(object sender, EventArgs e)
        {
            if (OutwardCode.Text != "")
            {
                ...
                string qry11 = "select Top 1 * from [InnonOutwardCarrierAgent] where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        protected void BtnExpAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                string Code = "";
                string qry11 = "SELECT Code FROM [InnonExporter] where Code='" + TxtExpCode.Text + "'";
                ...
                if (Code == "")
                {
                    ...
                    string strTime = System.DateTime.Now.ToString("yyyy/MM/dd");
                    string StrQuery = ("INSERT INTO [dbo].[InnonExporter] ([Code],[Name],[Name1],[CRUEI],[TouchUser],[TouchTime]) VALUES ('" + TxtExpCode.Text + "','" + TxtExpName.Text + "','" + TxtExpName1.Text + "','" + TxtExpCRUEI.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                    obj.exec(StrQuery);
                    BindExporter();
                }
                else
        ...
        public DataTable GetExportDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Top 10 Id,Code,Name,Name1,CRUEI FROM [InnonExporter] where Code Like '%" + ExporterSearch.Text + "%' or Name Like '%" + ExporterSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void TxtExpCode_TextChanged(object sender, EventArgs e)
        {
            if (TxtExpCode.Text != "")
            {
                ...
                string qry11 = "select Top 1 * from [InnonExporter] where Code='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
                    TxtExpCode.Text = obj.dr[1].ToString();
        ...
        protected void ConsigneeGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popupinnonconsignee.X = 400;
            popupinnonconsignee.Y = 100;
            BindConsignee();
        }
        ...
        {
            string Code = "";
            string qry11 = "SELECT ConsigneeCode FROM InnonConsignee where ConsigneeCode='" + ConsigneeCode.Text + "'";
            obj.dr = obj.ret_dr(qry11);
            while (obj.dr.Read())
            {
                Code = obj.dr[0].ToString();
            ...
            if (Code == "")
            {
                ...
                else
                {
                    string Touch_user = Session["UserId"].ToString();
                    string strTime = System.DateTime.Now.ToString("yyyy/MM/dd");
                    string StrQuery = ("INSERT INTO [dbo].[InnonConsignee] ([ConsigneeCode],[ConsigneeName],[ConsigneeName1],[ConsigneeCRUEI],[ConsigneeAddress],[ConsigneeAddress1],[ConsigneeCity],[ConsigneeSub],ConsigneeSubDivi,[ConsigneePostal],[ConsigneeCountry],[TouchUser],[TouchTime])  VALUES ('" + ConsigneeCode.Text + "','" + ConsigneeName.Text + "','" + ConsigneeName1.Text + "','" + ConsigneeCRUEI.Text + "','" + ConsigneeAddress.Text + "','" + ConsigneeAddress1.Text + "','" + ConsigneeCity.Text + "','" + ConsigneeSub.Text + "','" + ConsigneeSubDivi.Text + "','" + ConsigneePostal.Text + "','" + ConsigneeCountry.Text + "','" + Touch_user + "',Convert(VARCHAR,'" + strTime + "',108))");
                    obj.exec(StrQuery);
                    BindConsignee();
                }
            }
        ...
        public DataTable GetConsigneeDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT Top 10 * FROM InnonConsignee where ConsigneeCode Like '%" + ConsigneeSearch.Text + "%' or ConsigneeName Like '%" + ConsigneeSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void ConsigneeCode_TextChanged(object sender, EventArgs e)
        {
            if (ConsigneeCode.Text != "")
            {
                ...
                string qry11 = "select Top 1 * from InnonConsignee where ConsigneeCode='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
                    ConsigneeCode.Text = obj.dr[1].ToString();
        ...
        protected void ExportGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popupinnonstorageloc.X = 400;
            popupinnonstorageloc.Y = 100;
            BindExportPort();
        }
        ...
        public DataTable GetPortDataFromDataBase(string searchtext)
        {
            ...
            string str3 = "SELECT * LoadingPort where PortCode Like '%" + ExpLoadingSearch.Text + "%' or PortName like '" + ExpLoadingSearch.Text + "%' order by Id desc";
            obj.dr = obj.ret_dr(str3);
            if (obj.dr.HasRows)
            {
        ...
        protected void TxtExpLoadShort_TextChanged(object sender, EventArgs e)
        {
            if (TxtExpLoadShort.Text != "")
            {
                ...
                string qry11 = "select Top 1 * from LoadingPort where PortCode='" + ss[0].ToString() + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        protected void txtNextprt_TextChanged(object sender, EventArgs e)
        {
            if (txtNextprt.Text != "")
            {
                string qry11 = "select Top 1 * from LoadingPort where PortCode='" + txtNextprt.Text + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        protected void txtLasPrt_TextChanged(object sender, EventArgs e)
        {
            if (txtLasPrt.Text != "")
            {
                string qry11 = "select Top 1 * from LoadingPort where PortCode='" + txtLasPrt.Text + "'";
                obj.dr = obj.ret_dr(qry11);
                while (obj.dr.Read())
                {
        ...
        protected void NextPortGrid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            popupinnonnxtport.X = 400;
            popupinnonnxtport.Y = 100;
        ...
        protected void txtlastprt_TextChanged(object sender, EventArgs e)
        {
            ...
            popupinnonlastport.X = 400;
            popupinnonlastport.Y = 100;
        }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Save:
                            ...
                            string strTime = System.DateTime.Now.ToString("yyyy/MM/dd");
                            string StrQuery = ("INSERT INTO [dbo].[InNonHeaderTbl] ([Refid],[JobId],[MSGId],[PermitId],[TradeNetMailboxID],[MessageType],[DeclarationType],PreviousPermit,[CargoPackType],[InwardTransportMode],[OutwardTransportMode],[BGIndicator],[SupplyIndicator],[ReferenceDocuments],[License],[Recipient],[DeclarantCompanyCode],[ImporterCompanyCode],[ExporterCompanyCode],[InwardCarrierAgentCode],[OutwardCarrierAgentCode],[FreightForwarderCode],[ConsigneeCode],[ClaimantPartyCode],[ArrivalDate],[LoadingPortCode],[VoyageNumber],[VesselName],[OceanBillofLadingNo],[ConveyanceRefNo],[TransportId],[FlightNO],[AircraftRegNo],[MasterAirwayBill],[ReleaseLocation],[ReleaseLocaName],[RecepitLocation],RecepilocaName,StorageLocation,ExhibitionSDate,ExhibitionEDate,[BlanketStartDate],[TradeRemarks] ,[InternalRemarks],[CustomerRemarks] ,[DepartureDate],[DischargePort],[FinalDestinationCountry],[OutVoyageNumber],[OutVesselName],[OutOceanBillofLadingNo],[VesselType],[VesselNetRegTon],[VesselNationality],[TowingVesselID],[TowingVesselName],[NextPort],[LastPort],[OutConveyanceRefNo],[OutTransportId],[OutFlightNO],[OutAircraftRegNo],[OutMasterAirwayBill],[TotalOuterPack],[TotalOuterPackUOM],[TotalGrossWeight],[TotalGrossWeightUOM],GrossReference,[DeclareIndicator],[NumberOfItems],[TotalCIFFOBValue],[TotalGSTTaxAmt],[TotalExDutyAmt],[TotalCusDutyAmt],[TotalODutyAmt],[TotalAmtPay],[Status],[prmtStatus],[Inhabl],[outhbl],[seastore],[TouchUser],[TouchTime])  VALUES('" + refno.ToUpper() + "','" + JobNo.ToUpper() + "','" + MsgNO.ToUpper() + "','" + txt_code.Text + "','" + TxtTradeMailID.Text.ToUpper() + "','" + TxtMsgType.Text.ToUpper() + "','" + DrpDecType.SelectedItem.ToString() + "','" + TxtPrevPerNO.Text.ToUpper() + "','" + DrpCargoPackType.SelectedItem.ToString() + "','" + DrpInwardtrasMode.SelectedItem.ToString() + "','" + DrpOutwardtrasMode.SelectedItem.ToString() + "','" + DrpBGIndicator.SelectedItem.ToString() + "','" + ChkSupplyIndicator.Checked.ToString() + "','" + ChkRefDoc.Checked.ToString().ToLower() + "','" + License.ToUpper() + "','" + Recipient.ToUpper() + "', '" + TxtDecCompCode.Text.ToUpper() + "','" + TxtImpCode.Text.ToUpper() + "','" + TxtExpCode.Text.ToUpper() + "','" + InwardCode.Text.ToUpper() + "','" + OutwardCode.Text.ToUpper() + "','" + FrieghtCode.Text.ToUpper() + "','" + ConsigneeCode.Text.ToUpper() + "','" + ClaimantName.Text.ToUpper() + "','" + Convert.ToDateTime(ArrivalDate).ToString("yyyy/MM/dd") + "','" + TxtLoadShort.Text + "','" + TxtVoyageno.Text.ToUpper() + "','" + TxtVesselName.Text.ToUpper() + "','" + TxtOceanBill.Text.ToUpper() + "','" + TxtConRefNo.Text.ToUpper() + "','" + TxtTrnsID.Text + "','" + txtflight.Text.ToUpper() + "','" + txtaircraft.Text.ToUpper() + "','" + txtwaybill.Text.ToUpper() + "','" + txtreLoctn.Text.ToUpper() + "','" + txtrelocDeta.Text.ToUpper() + "','" + txtrecloctn.Text.ToUpper() + "','" + txtrecloctndet.Text.ToUpper() + "','" + txtstrgeloc.Text + "','" + txtExStartDate.Text + "','" + txtExEndDate.Text + "','" + Convert.ToDateTime(BlanketDate).ToString("yyyy/MM/dd") + "','" + txttrdremrk.Text + "','" + txtintremrk.Text + "','" + txtcusRemrk.Text + "','" + Convert.ToDateTime(DepatureDate).ToString("yyyy/MM/dd") + "','" + TxtExpLoadShort.Text + "','" + DrpFinalDesCountry.SelectedItem + "','" + OUTWARDVoyageNo.Text + "','" + OUTWARDVessel.Text + "','" + OUTWARDOcenbill.Text + "','" + ddpVessel.SelectedItem + "','" + txtvesnet.Text + "','" + DroVesslNat.SelectedItem + "','" + txtTowVes.Text + "','" + txtTowVesName.Text + "','" + txtNextprt.Text + "','" + txtLasPrt.Text + "','" + OUTWARDConref.Text + "','" + OUTWARDTransId.Text + "','" + OUTWARDFlightN0.Text + "','" + OUTWARDAirREgno.Text + "','" + OUTWARDAirwaybill.Text + "','" + TxttotalOuterPack.Text + "','" + DrptotalOuterPack.SelectedItem.ToString() + "','" + TxtTotalGrossWeight.Text + "','" + DrpTotalGrossWeight.SelectedItem.ToString() + "','" + TxtGrossReference.Text + "','" + chkalrt.Checked.ToString().ToLower() + "','" + txtnoofitm.Text + "','" + txtfobval.Text + "','" + txttotgstAmt.Text + "','" + txttotexAmt.Text + "','" + txtcusdutyAmt.Text + "','" + txtothtaxAmt.Text + "','" + txtAmtPayble.Text + "','NEW','NEW','" + txthblCargo.Text + "','" + txtouthblCargo.Text + "','" + chkSea.Checked.ToString() + "','" + Touch_user + "','" + strTime + "')");
                            chkCode = obj.exec(StrQuery);
                            if (chkCode == -2146232060)
                            {
                                refid();
        ...
        protected void txtlsp_TextChanged(object sender, EventArgs e)
        {
            if (txtlsp.Text != "")
            {
                ...
                T6 = ((T4 * 0.07) + (T5 * 0.07) + (T7 * 0.07) + (T7 * 0.07));
        ...
        public void Container()
        {
            ...
            if (FileUpload4.HasFile)
            {
                try
                {
                    ...
                    {
                        con.Open();
                        string MessageType = "IPTDEC", TouchUser = Session["UserId"].ToString();
                        string strTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
        ...
        {
            LblOutoblmawb.Text = OUTWARDOcenbill.Text;
        }

        protected void OUTWARDAirwaybill_TextChanged(object sender, EventArgs e)
        {
            LblOutoblmawb.Text = OUTWARDAirwaybill.Text;
        ...
        protected void btnprev_Click(object sender, EventArgs e)
        {
            ...
            string Invoice = txt_code.Text;
            string striW = "select * from [InNonInvoiceDtl] where MessageType='IPTDEC' AND PermitId='" + Invoice + "'  order by InvoiceNo";
            obj.dr = obj.ret_dr(striW);
            obj.BindDropDown(DrpInvoiceNo, obj.dr, "Id", "InvoiceNo");
            //DrpInvoiceNo.DataSource = null;
            //DrpInvoiceNo.DataSource = obj.dr;
