<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="InpaymentList.aspx.cs" Inherits="RET.InpaymentList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="row top-pad" style="margin-top: -17px;">
		<div class="col-md-12">
			<ol class="breadcrumb">
				<li class="active" style ="font-size :medium; font-weight :bold;">
					<i class="fa fa-dashboard"></i>&nbsp;&nbsp;Inpayment
				</li>
			</ol>
		</div>
	</div>--%>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Declarant Company Search </h4>
                </div>
    ...
    <div class="flex gap-y-3 items-center justify-between flex-wrap">
        ...
        <div>
            <h1 class="text-2xl sa700 leading-normal text-gray-800">In-Payment
            </h1>
        </div>
        <div class="flex items-center gap-4 lg:flex-nowrap flex-wrap">
            ...
            <a href="Inpayment.aspx" id="Inpay" runat="server" class="hover:no-underline  w-full  md:w-[160px]">
            ...
            <asp:Button ID="btndelete" OnClientClick="return confirm('Are you sure you want to Delete all Selected entries?');" runat="server" Text="Delete All" OnClick="btndelete_Click" class="duration-300 group ease-in-out gap-3 md:w-20 w-full bg-white text-gray-500 text-sm font-medium hover:bg-transparent border border-transparent hover:border hover:border-gray-200 h-10 flex items-center justify-center text-center rounded-md" />
            ...
            <%--<button type="button" class="btn1 btn-primary">Delete</button>--%>
            ...
            <div class="group relative z-10">
                ...
                <div id="dropdown" class="hidden relative drop-shadow">
                    ...
                    <div
                        ...
                        <asp:Button ID="btnDownCCP" runat="server" Text="Download CCP" class="w-full text-left py-2 px-6 text-sm text-gray-500 hover:text-[#0560FD] hover:font-medium hover:bg-[#0560FD] hover:bg-opacity-10 hover:rounded" Style="display: none;" />
                        <asp:Button ID="btnrefundccp" runat="server" Text="Print REFUND" OnClick="btnrefundccp_Click" class="w-full text-left py-2 px-6 text-sm text-gray-500 hover:text-[#0560FD] hover:font-medium hover:bg-[#0560FD] hover:bg-opacity-10 hover:rounded" />
                        <asp:Button ID="btnRejectSta" runat="server" Text="Rejected Status" OnClick="btnRejectSta_Click" class="w-full text-left py-2 px-6 text-sm text-gray-500 hover:text-[#0560FD] hover:font-medium hover:bg-[#0560FD] hover:bg-opacity-10 hover:rounded" />
                        <asp:Button ID="btnCanSta" runat="server" Text="Cancelled Status" OnClick="btnCanSta_Click" class="w-full text-left py-2 px-6 text-sm text-gray-500 hover:text-[#0560FD] hover:font-medium hover:bg-[#0560FD] hover:bg-opacity-10 hover:rounded" />
    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional" class="amend-options">
        <ContentTemplate>
            <div id="ACR" runat="server" visible="false" class="flex gap-x-2 items-center justify-end mt-[20.5px]">
                <asp:Label runat="server" ID="LB" class="text-1xl sa760 leading-normal text-gray-700" Text="AMEND/CANCEL/REFUND"></asp:Label>
                <asp:DropDownList ID="Drppermitedit" runat="server" Width="150" class="outline-none duration-300 group ease-in-out gap-3 md:w-[120px] w-full bg-white text-gray-500 text-sm font-medium hover:bg-transparent border border-transparent hover:border hover:border-gray-200 h-10 flex items-center justify-center text-center rounded-md" AutoPostBack="true" OnSelectedIndexChanged="Drppermitedit_SelectedIndexChanged">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="GridInPayment" ShowHeaderWhenEmpty="true" EmptyDataText="No Records found" PageSize="10" Width="100%" FooterStyle-CssClass="w-full h-10 py-4 px-10 bg-[#F4F6FA] rounded-lg" CssClass="w-full bg-white rounded whitespace-nowrap" HeaderStyle-CssClass="w-full h-10 py-4 px-10 bg-[#F4F6FA] rounded-l-lg" PagerStyle-CssClass="pager" RowStyle-CssClass="rows" OnRowDeleting="GridInPayment_RowDeleting" AllowPaging="true" DataKeyNames="Id" OnPageIndexChanging="GridInPayment_PageIndexChanging" runat="server" ShowFooter="true" AutoGenerateColumns="false" OnRowDataBound="GridInPayment_RowDataBound" OnRowCommand="GridInPayment_RowCommand" RowStyle-Font-Bold="true">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-CssClass="text-xs leading-none py-3 md:px-0 px-2 text-gray-800 w-5 relative" HeaderStyle-CssClass="font-medium leading-none md:px-0 px-2 rounded-l-lg text-base text-gray-600 text-left w-[20px]">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div class="flex gap-4 items-center pl-6 relative">
                                            <%--<input class="styled-checkbox-3" id="styled-checkbox-56" type="checkbox" value="value1">--%>
                                            <div class="custom-check">
                                                <span>
                                                    <asp:CheckBox ID="CheckBox1" runat="server" OnCheckedChanged="CheckBox1_CheckedChanged" AutoPostBack="true" />
                                                </span>
                                                <%--<input type="checkbox" class="styled-checkbox-3" ID="CheckBox1" />--%>
                                ...
                                <%--<asp:TemplateField HeaderText="Edit" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ImageUrl="~/IMG/edit.png" Width="11" Height="11" OnClick="InpaymentEdit_Click" ID="InpaymentEdit" runat="server" />
                                                        <asp:LinkButton OnClick="imgDelete_Click" data-target='<%#"#"+DataBinder.Eval(Container.DataItem,"Id")%>' Width="11" Height="11" ID="imgDelete" runat="server"> </asp:LinkButton>
                                                        <i class='fa fa-trash' style="color: red;"></i>
                                                    </ItemTemplate>
                                                </asp:TemplateField>--%>
                                <%-- <asp:TemplateField HeaderText="Delete" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500  px-2 text-left">
                                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="JobId" SortExpression="JobId" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500  px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox class="w-full h-10 rounded-md flex items-center text-slate-950 text-lg font-medium outline-none border-none px-4" placeholder="Search" ID="txtJobId" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtJobId_TextChanged1" Text='<%# Bind("JobId") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="DeclarationType" SortExpression="DeclarationType" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtDeclarationType" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtDeclarationType_TextChanged" Text='<%# Bind("DeclarationType") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Createby" SortExpression="Createby" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtCreateby" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtCreateby_TextChanged" Text='<%# Bind("DeclarationType") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="DecId" SortExpression="DecId" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtDecId" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtDecId_TextChanged" Text='<%# Bind("DecId") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="ETA" SortExpression="ETA" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblETA" Width="60" runat="server" Text='<%#Eval("ETA")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtETA" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtETA_TextChanged" Text='<%# Bind("ETA") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="LocalNo" SortExpression="LocalNo" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtLocalNo" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtLocalNo_TextChanged" Text='<%# Bind("PermitNo") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="PermitNo" SortExpression="PermitNo" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtPermitNo" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtPermitNo_TextChanged" Text='<%# Bind("PermitNumber") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Importer" SortExpression="Importer" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblImporter" Width="260" runat="server" Text='<%#Eval("Importer")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtImporter" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtImporter_TextChanged" Text='<%# Bind("Importer") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="InHAWBOBL" SortExpression="InHAWBOBL" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtInHAWBOBL" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtInHAWBOBL_TextChanged" Text='<%# Bind("InHAWBOBL") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="MAWBOBL" SortExpression="MAWBOBL" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblMAWBOBL" runat="server" Text='<%#Eval("MAWBOBL")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtMAWBOBL" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtMAWBOBL_TextChanged" Text='<%# Bind("MAWBOBL") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="LoadingPortCode" SortExpression="LoadingPortCode" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">

                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblLoadingPortCode" runat="server" Text='<%#Eval("LoadingPortCode")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtLoadingPortCode" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtLoadingPortCode_TextChanged" Text='<%# Bind("LoadingPortCode") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="MessageType" SortExpression="MessageType" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtMessageType" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtMessageType_TextChanged" Text='<%# Bind("MessageType") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="InwardTransportMode" SortExpression="InwardTransportMode" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblInwardTransportMode" runat="server" Text='<%#Eval("InwardTransportMode")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtInwardTransportMode" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtInwardTransportMode_TextChanged" Text='<%# Bind("InwardTransportMode") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="PreviousPermit" SortExpression="PreviousPermit" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblPreviousPermit" runat="server" Text='<%#Eval("PreviousPermit")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtPreviousPermit" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtPreviousPermit_TextChanged" Text='<%# Bind("PreviousPermit") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="InternalRemarks" SortExpression="InternalRemarks" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtInternalRemarks" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtInternalRemarks_TextChanged" Text='<%# Bind("InternalRemarks") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <%-- <asp:TemplateField HeaderText="TermType" SortExpression="TermType" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblTermType" runat="server" Text='<%#Eval("TermType")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox   class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search"  ID="txtTermType" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtTermType_TextChanged" Text='<%# Bind("TermType") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>--%>
                                <asp:TemplateField HeaderText="GSTSUMAmount" SortExpression="GSTSUMAmount" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblGSTSUMAmount" runat="server" Text='<%#Eval("GSTSUMAmount")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtGSTSUMAmount" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtGSTSUMAmount_TextChanged" Text='<%# Bind("GSTSUMAmount") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="SumOFItem" SortExpression="SumOFItem" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtSumOFItem" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtSumOFItem_TextChanged" Text='<%# Bind("SumOFItem") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Status" SortExpression="Status" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtStatus" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtStatus_TextChanged" Text='<%# Bind("Status") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
        ...
        <div class="col-md-12 ">
            <div class="dropdown ">
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                    Show Columns <span class="caret"></span>
                </button>
                <ul class="dropdown-menu ">

                    <hr />
                    <center>
                        <asp:Button ID="Button1" runat="server" Text="Button" class="btn1 btn-primary " OnClick="Button1_Click" />
                    </center>
                </ul>
            </div>
        </div>
