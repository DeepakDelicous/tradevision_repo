<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="OutList.aspx.cs" Inherits="RET.OutList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="flex gap-y-3 items-center justify-between flex-wrap">
        ...
        <div>
            <h1 class="text-2xl sa700 leading-normal text-gray-800">Outward
              </h1>
        </div>
        <div class="flex items-center gap-4 lg:flex-nowrap flex-wrap">
            ...
            <a href="Out.aspx" id="Inpay" runat="server" class="hover:no-underline  w-full  md:w-[160px]">
            ...
            <asp:Button ID="btndelete" runat="server" OnClick="btndelete_Click" Text="Delete All" class="duration-300 group ease-in-out gap-3 md:w-20 w-full bg-white text-gray-500 text-sm font-medium hover:bg-transparent border border-transparent hover:border hover:border-gray-200 h-10 flex items-center justify-center text-center rounded-md" />
      ...
      <p class="text-slate-500 text-xs font-medium py-3 px-2">
          <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtJobId" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtJobId_TextChanged1" Text='<%# Bind("JobId") %>'>
                                ...
                                <asp:TemplateField HeaderText="MSGId" SortExpression="MSGId" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500  px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"   class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtMSGId" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtMSGId_TextChanged" Text='<%# Bind("MSGId") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="DecDate" SortExpression="DecDate" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500  px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtDecDate" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtDecDate_TextChanged" Text='<%# Bind("DecDate") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="CertificateNo" SortExpression="CertificateNo" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblCertificateNo" Width="260" runat="server" Text='<%#Eval("CertificateNo")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtCertificateNo" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtPermitNo_TextChanged" Text='<%# Bind("CertificateNo") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="COType" SortExpression="COType" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblCOType" runat="server" Text='<%#Eval("COType")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtCOType" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtPermitNo_TextChanged" Text='<%# Bind("COType") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="CerDetailtype1" SortExpression="CerDetailtype1" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblCerDetailtype1" runat="server" Text='<%#Eval("CerDetailtype1")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtCerDetailtype1" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtPermitNo_TextChanged" Text='<%# Bind("CerDetailtype1") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="CurrencyCode" SortExpression="CurrencyCode" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtCurrencyCode" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtPermitNo_TextChanged" Text='<%# Bind("CurrencyCode") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Exporter" SortExpression="Exporter" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblExporter" runat="server" Text='<%#Eval("Exporter")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="POD" SortExpression="POD" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                ...
                                <asp:TemplateField HeaderText="OutwardTransportMode" SortExpression="OutwardTransportMode" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtOutwardTransportMode" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtOutwardTransportMode_TextChanged" Text='<%# Bind("OutwardTransportMode") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="GSTSUMAmount" SortExpression="GSTSUMAmount" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtGSTSUMAmount" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtGSTSUMAmount_TextChanged" Text='<%# Bind("GSTSUMAmount") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
