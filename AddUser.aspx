<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="RET.AddUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="flex md:justify-between items-center gap-4 mb-4 mt-6 md:flex-nowrap flex-wrap">
        <div class="flex gap-2 items-center">
            ...
            <p class="text-slate-950 text-sm sa700">Add New Master User</p>
        </div>
    ...
    <div class="w-full bg-white my-shadow rounded-2xl px-6 py-6">
                    ...
                    <div class="flex justify-between gap-2 items-center mt-2">
                        <h2 class="text-lg sa700 leading-[18px] text-gray-800">Add User Master
                        </h2>
                    </div>
                    ...
                    <form class="form-horizontal">
                            ...
                            <div class="mt-4 flex items-end gap-4 lg:flex-nowrap flex-wrap mb-2">
                                  <div class="w-full">
                                    ...
                                    <div class="w-full">
                                        <label for="inputPassword" class="text-gray-500 text-sm font-medium">Mobile No</label>
                                        <div class="relative mt-1">
                                            <asp:TextBox ID="TxtMobile" runat="server" CssClass="w-full h-10 bg-slate-100 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="w-full">
                                        <label class="text-gray-500 text-sm font-medium">Email Address</label>
                                        <div class="relative mt-1">
                                            <asp:TextBox ID="TxtEmail" runat="server"  CssClass="w-full h-10 bg-slate-100 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"></asp:TextBox>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="mt-4 flex items-end gap-4 lg:flex-nowrap flex-wrap mb-2">
                                <div class="w-full">
                                     <label class="text-gray-500 text-sm font-medium">Designation</label>
                                     <div class="relative mt-1">
                                         <asp:DropDownList ID="DrpDesig" CssClass="w-full h-10 bg-slate-100 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4" OnSelectedIndexChanged="DrpDesig_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="true" runat="server">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="DrpDesig" ErrorMessage="Please Select Type "
                                            Display="Dynamic" InitialValue="0" ValidationGroup="ItemMasterValidation" ForeColor="Red"></asp:RequiredFieldValidator>
                                     </div>
                                </div>

                                <div class="w-full">
                                    <label class="text-gray-500 text-sm font-medium">Emp Code</label>
                                    <div class="relative mt-1">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative mt-1">
                                        <asp:TextBox ID="TxtUserName" runat="server"  CssClass="w-full h-10 bg-slate-100 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 flex items-end gap-4 lg:flex-nowrap flex-wrap mb-2">
                                <div class="w-full">
                                    ...
                                    <div class="relative mt-1">
                                        <asp:TextBox ID="TxtPassword" runat="server"  CssClass="w-full h-10 bg-slate-100 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4" ></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative mt-1">
                                        <asp:TextBox ID="TxtConPassword" runat="server"  CssClass="w-full h-10 bg-slate-100 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"></asp:TextBox>
                                    </div>
                                </div>
                     ...
                     <div class="col-sm-6 col-md-6 col-lg-6  col-xs-8">
                        <div class="col-md-8 col-sm-8 col-lg-10 col-xs-12 moverightalert">

                            <label for="inputEmail" class="control-label" id="nameerrormeg" runat="server" style="color: red;"></label>
                            <label for="inputEmail" class="control-label" id="useriderrormeg" runat="server" style="color: red;"></label>
