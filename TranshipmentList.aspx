<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="TranshipmentList.aspx.cs" Inherits="RET.TranshipmentList" %>
...
<img alt="" src="Loader.gif" width="100" height="100" /></center>
    ...
    <div class="flex gap-y-3 items-center justify-between flex-wrap">
        ...
        <div>
            <h1 class="text-2xl sa700 leading-normal text-gray-800">Transhipment
              </h1>
        </div>
        <div class="flex items-center gap-4 lg:flex-nowrap flex-wrap">
            ...
            <a href="Transhipment.aspx" id="Inpay" runat="server" class="hover:no-underline  w-full  md:w-[160px]">
      ...
      <p class="text-slate-500 text-xs font-medium py-3 px-2">
          <asp:TextBox  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"  placeholder="Search" ID="txtJobId" runat="server" ForeColor="Black"   AutoPostBack="true" OnTextChanged="txtJobId_TextChanged1" Text='<%# Bind("JobId") %>'>
                                ...
                                <asp:TemplateField HeaderText="ETA" SortExpression="ETA" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtETA" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtETA_TextChanged" Text='<%# Bind("ETA") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Importer" SortExpression="Importer" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    <ItemTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2">
                                            <asp:Label ID="lblImporter" Width="260" runat="server" Text='<%#Eval("transImporter")%>'>
                                            </asp:Label>
                                        </p>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtImporter" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtImporter_TextChanged" Text='<%# Bind("Importer") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="LoadingPortCode" SortExpression="LoadingPortCode" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox  placeholder="Search"  class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtLoadingPortCode" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtLoadingPortCode_TextChanged" Text='<%# Bind("LoadingPortCode") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="InwardTransportMode" SortExpression="InwardTransportMode" HeaderStyle-CssClass="text-sm font-medium leading-none text-gray-500 px-2 text-left">
                                    ...
                                    <FooterTemplate>
                                        <p class="text-slate-500 text-xs font-medium py-3 px-2" >
                                            <asp:TextBox   placeholder="Search" class="w-full h-10 rounded-md flex items-center text-slate-950 text-sm font-medium outline-none border-none px-4"   ID="txtInwardTransportMode" runat="server" ForeColor="Black"  AutoPostBack="true" OnTextChanged="txtInwardTransportMode_TextChanged" Text='<%# Bind("InwardTransportMode") %>'>
                                            </asp:TextBox>
                                        </p>
                                    </FooterTemplate>
                                </asp:TemplateField>
